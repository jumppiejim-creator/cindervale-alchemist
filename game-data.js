...
var SEASONS={
  ...
  tidecrest:[
    {id:'calm_seas',name:'Calm Seas',icon:'🌤️',color:'#60a0c0',
    ...
    {id:'storm_season',name:'Storm Season',icon:'⛈️',color:'#4060a0',
    ...
    {id:'migration',name:'Migration',icon:'🐋',color:'#40a080',
    ...
    {id:'frozen_tides',name:'Frozen Tides',icon:'🧊',color:'#8090b0',
