...
var QUESTS=[
  ...
  {id:'aq22',name:'Guild Armory Order',giver:'Razak',loc:'market',type:'deliver',target:'glass_bloom_elixir',count:2,xp:260,gold:90,items:['obsidian_shard','obsidian_shard','obsidian_shard'],unlock:6,faction:'sand_merchants',fRep:35,reqQuest:'aq6',
    desc:'The Sand Merchants Guild needs Glass Bloom Elixirs for their armory.',hint:'Brew 2 Glass Bloom Elixirs.',
    offer:['"The Guild is commissioning enchanted glass armor. Experimental."','"Two Glass Bloom Elixirs for the tempering process. Only the best."'],
    turnIn:['"The armor holds. Glass harder than steel. The Guild Master is impressed."']},
  ...
  {id:'aq24',name:'Sola\'s Last Resort',giver:'Sola',loc:'market',type:'deliver',target:'dragon_fire_flask',count:2,xp:300,gold:110,items:['living_ember','living_ember'],unlock:7,faction:null,fRep:0,reqQuest:'aq12',
    desc:'Sola needs Dragon Fire Flasks for a desperate defense.',hint:'Brew 2 Dragon Fire Flasks.',
    offer:['"Something big is moving in the deep desert. Something we can\'t fight with steel."','"Two Dragon Fire Flasks. If this doesn\'t stop it, nothing will."'],
    turnIn:['"*stares at the flasks* These could level a dune. Let\'s hope we never have to use them."']},
  {id:'aq25',name:'Pathfinder\'s Legacy',giver:'Tarek',loc:'tavern',type:'deliver',target:'spirit_draught',count:2,xp:290,gold:105,items:['mirage_dust','mirage_dust','mirage_dust'],unlock:7,faction:'dustwalkers',fRep:40,reqQuest:'aq11',
    desc:'Tarek wants Spirit Draughts to honor the Dustwalker founders.',hint:'Brew 2 Spirit Draughts.',
    offer:['"Every decade, we brew a draught and pour it on the founders\' stones."','"Two Spirit Draughts. The old pathfinders deserve the best."'],
