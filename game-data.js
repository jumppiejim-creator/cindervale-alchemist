...
var CLASSES={
  alchemist:{id:'alchemist',name:'Alchemist',icon:'⚗️',color:TH.green,primaryStat:'inu',
    ...
    specs:{
      apothecary:{id:'apothecary',name:'Apothecary',desc:'Healers and clinicians. Cure ailments, brew restorative potions, and earn gold treating patients.',mechDesc:'Clinic. Patients arrive daily with ailments that must be diagnosed (Attunement check, DC scales with ailment tier) and treated with the right healing potion. Successful treatments earn XP, gold, and reputation. From Lv6 you also brew one free Healing Salve each morning. Higher Apothecary levels improve diagnosis accuracy: Lv6 grants partial diagnosis even on near-miss rolls, and Lv10 always returns a full diagnosis.',icon:'💊',color:'#50c070',bStat:'inu',bSkills:['attunement','divination'],
        features:[
  ...
  enchanter:{id:'enchanter',name:'Enchanter',icon:'✨',color:TH.purple,primaryStat:'tec',
    ...
    features:[
      ...
      {classLv:6,name:'Resonance',desc:'Enchanting customers pay 25% more gold. 20% chance to save enchanting materials. Mastering this level grants two resonance-themed enchantment patterns.',effects:{enchantGoldBonus:0.25,enchantMatSave:0.20},grantEnchants:{pool:['e_echo_strike','e_runespark'],count:2}},
    ...
    specs:{
      runesmith:{id:'runesmith',name:'Runesmith',desc:'Forge powerful weapon enchantments. Martial runes command top prices from warriors and adventurers.',mechDesc:'Runesmith Forge. A dedicated forging station appears in your workshop where you can craft magical weapons. Each day you get a limited number of forge uses (1 at Lv3, scaling to 3 at Lv10). Forged weapons sell at premium prices and weapon enchantments get bonus value.',icon:'⚔️',color:'#d08040',bStat:'tec',bSkills:['inscription','refinement'],
        features:[
          {classLv:3,name:'Battle Runes',desc:'+1 inscription bonus and +15% gold on weapon enchantments specifically.',effects:{},categoricalEnchantBonus:{weapon:{enchantBonus:1,enchantGoldBonus:0.15}}},
          ...
          {classLv:10,name:'Legendary Arms',desc:'+50% gold on weapon enchantments specifically. Inscriptions auto-succeed at DC 14 or below, and natural-20 crits produce Masterwork enchantments.',effects:{masterworkOnCrit:true,autoEnchantDC:14},categoricalEnchantBonus:{weapon:{enchantGoldBonus:0.50}}},
        ]},
      ...
      spellweaver:{id:'spellweaver',name:'Spellweaver',desc:'Craft exotic utility enchantments and tap into planar power sources. Attract rare, high-paying customers.',mechDesc:'Planar Attunement. Attune to one of four extraplanar sources via the Planar Focus interface for 1 day (2 days from Lv6). Each plane delivers a real tradeoff — boons paired with costs: Feywild gives +30% gold on accessory/utility ("other") enchants but a 10% per-success chance of a dissatisfied customer (−10g refund and −1 to your aligned faction\'s rep); Shadowfell gives +2 inscription on armor enchants but +3 DC on weapon enchants; Elemental Chaos triggers a 20% per-success planar surge (+50% gold and +50% XP) but failed inscriptions destroy all materials; Astral Sea reduces DC by 2 on all enchants but pays 15% less gold. Standard Spellweaver bonuses focus on the "other" enchantment category (accessory/utility inscriptions: rings, cloaks, charms): +1 inscription at Lv3, +35% gold and +1 customer slot at Lv6. At Lv10, **Planar Convergence** unlocks — attune a second plane while the first is still active, fusing them into a combo (Twilight Veil, Wild Magic, Dreamweave, Void Storm, Null Space, or Primordial Order). **The combo\'s effects replace both planes\' individual effects** — convergence is a mode switch, not additive stacking. Lv10 also grants inscription crits on 17+, +50% gold from enchanting overall, and +30% gold from potion customers.',icon:'🌀',color:'#a060e0',bStat:'inu',bSkills:['arcane_sense','divination'],
        features:[
          ...
          {classLv:10,name:'Planar Convergence',desc:'Inscription crits on 17+. +50% gold from enchanting. +30% gold from potion customers (planar patronage attracts wealthy clientele).',effects:{enchantCritRange:17,enchantGoldBonus:0.50,customerPayBonus:0.30}},
        ]},
    }},
    ...
    specs:{
      ...
      archivist:{id:'archivist',name:'Archivist',desc:'Pursue lore fragments and quest chains. Board quests refresh faster, and deep knowledge grants permanent stats.',mechDesc:'Lore Fragments. Discover ancient lore fragments during quests and research. Fragments form chains that, when completed, grant permanent passive bonuses. The Lore Archive tracks your collection and shows incomplete chains. Board quests refresh more often and reward bonus reputation.',icon:'📜',color:'#c0a060',bStat:'dis',bSkills:['research','focus'],
        features:[
          ...
          {classLv:6,name:'Master Index',desc:'The notice board refreshes twice as often (more quests per cycle). +25% gold from quest turn-ins.',effects:{doubleQuestRefresh:true,questGoldBonus:0.25}},
...
var FACTION_PAIRS=[
  ...
  {id:'fp_tc_pd_mm',factions:['pearl_divers','merchant_marine'],name:'Pearl Divers ↔ Merchant Marine',icon:'🤿🚢',dc:10,loc:'tidecrest',
    ...
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','Ingredients sell +2g each, +25% all reputation gains'],
  ...
  {id:'fp_sr_sw_sc',factions:['skywardens','starcallers'],name:'Skywardens ↔ Starcallers',icon:'🦅🌠',dc:10,loc:'skyreach',
    ...
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','+15% quest gold, +25% all reputation gains'],
  ...
  {id:'fp_sr_sw_wr',factions:['skywardens','windrunners'],name:'Skywardens ↔ Windrunners',icon:'🦅🌪️',dc:13,loc:'skyreach',
    ...
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','Armor enchants +25% gold, +25% all reputation gains'],
...
var PRESTIGE_CLASSES={
  ...
  spellbrewer:{id:'spellbrewer',name:'Spellbrewer',icon:'⚗️',color:'#9060c0',
    ...
    features:[
      ...
      {lv:5,name:'Grand Spellbrewer',desc:'6 infusions per day. Infusion sale-multipliers are 50% more potent (Vigor 1.2× becomes 1.3×, Prosperity 1.5× becomes 1.75×, etc.) and infused items pay +30% gold. Infused shelf potions also attract +15% extra sell chance.',effects:{infusionSlots:6,infusedSellBonus:0.30}},
    ]},
  ...
  brandmaster:{id:'brandmaster',name:'Brand Master',icon:'🏷️',color:'#d0a060',
    ...
    features:[
      ...
      {lv:5,name:'Legendary Brand',desc:'3rd brand slot. Every branded item sells for an additional +25% gold on top of brand-level bonuses. 25% brand rep carries through Torch.',effects:{brandSlots:3,maxRecipes:4,torchBrandRep:0.25}},
    ]},
