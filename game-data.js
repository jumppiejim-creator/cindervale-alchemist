...
var RECIPES=[
  ...
  {id:'sandglass_lens',name:'Sandglass Lens Tonic',icon:'🪟',ingr:['sand_glass','palm_resin'],xp:35,unlock:1,dc:9,stat:'tec',
  ...
  {id:'molten_pearl_elixir',name:'Molten Pearl Elixir',icon:'🫧',ingr:['molten_pearl','temple_jade'],xp:105,unlock:6,dc:17,stat:'inu',
    desc:'A pearl from the caldera dissolved in temple jade essence. Grants fire immunity for a day.'},
  {id:'relic_restoration',name:'Relic Restoration Fluid',icon:'🏺',ingr:['buried_relic','oasis_pearl','pharaoh_dust'],xp:130,unlock:7,dc:18,stat:'acu',
    desc:'An archaeologist\'s dream — liquid that reverses millennia of decay. Nahla\'s personal formula.'},
  {id:'desert_star_elixir',name:'Desert Star Elixir',icon:'⭐',ingr:['desert_star','sun_crown_shard','dustwalker_compass'],xp:170,unlock:8,dc:20,stat:'cre',
