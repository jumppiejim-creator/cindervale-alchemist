...
var NPCS={
  ...
  // ═══ SKYREACH NPCs ═══
  sr_kael:{id:'sr_kael',name:'Kael Windforge',icon:'👨‍🦳',loc:'market',
    ...
    gossip:false},
  sr_lira:{id:'sr_lira',name:'Lira Cloudwhisper',icon:'🧝‍♂️',loc:'tavern',
    ...
    gossip:false},
  sr_bron:{id:'sr_bron',name:'Old Bron Stonefoot',icon:'👴',loc:'tavern',
    ...
    gossip:false},
  sr_yuki:{id:'sr_yuki',name:'Yuki Starsight',icon:'🧑‍🏫',loc:'tavern',
    ...
    gossip:false},
  sr_mika:{id:'sr_mika',name:'Mika the Wind',icon:'🧒',loc:'tavern',
