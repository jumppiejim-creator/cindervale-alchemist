...
var PRESTIGE_CLASSES={
  cartographer:{id:'cartographer',name:'Cartographer',icon:'🗺️',color:'#50a0a0',
    ...
    features:[
      {lv:1,name:'Hidden Paths',desc:'Discover secret sub-areas within known regions with unique ingredients. 25% chance per forage hour.'},
      {lv:2,name:'Detailed Maps',desc:'Hidden area discovery chance +15%. Mapped areas yield +1 bonus ingredient.'},
      {lv:3,name:'Cartographer\'s Insight',desc:'See all ingredients in a region before committing to forage. +10% XP from foraging.'},
      {lv:4,name:'Pathfinder\'s Network',desc:'Staff foraging uses your mapped paths: +25% staff forage yield.'},
      {lv:5,name:'Legendary Atlas',desc:'Discover the Heartforge\'s hidden chambers. Unique legendary ingredients only you can access.'},
    ]},
  ...
  magitech:{id:'magitech',name:'Magitech Engineer',icon:'🔧',color:'#a0a060',
    ...
    features:[
      {lv:1,name:'Automaton Frame',desc:'Build a basic automaton (1 active). Performs one task per day at 60% efficiency.'},
      {lv:2,name:'Improved Servos',desc:'Automaton efficiency +20%. Can assign to brew, forage, or shopkeep.'},
      {lv:3,name:'Second Automaton',desc:'+1 automaton slot (2 total). Automata gain XP and level up like staff.'},
      {lv:4,name:'Enchanted Core',desc:'Automata can perform enchanting tasks. Efficiency +20% (total 100%).'},
      {lv:5,name:'Master Construct',desc:'+1 automaton (3 total). Automata can perform prestige tasks. Self-repairing.'},
    ]},
  ...
  arcanist:{id:'arcanist',name:'Arcanist',icon:'✨',color:'#8060c0',
    ...
    features:[
      {lv:1,name:'Pattern Research',desc:'Spend 2h to research a new enchantment pattern. Choose effect type and power level.'},
      {lv:2,name:'Refined Patterns',desc:'Custom enchantments get +2 inscription bonus. Can name your creations.'},
      {lv:3,name:'Dual-Effect Patterns',desc:'Design enchantments with two effects. Custom patterns sell at 2× value.'},
      {lv:4,name:'Pattern Library',desc:'Store up to 10 custom patterns. Share patterns with staff for automated inscribing.'},
      {lv:5,name:'Grand Theorem',desc:'Design legendary enchantments. Custom patterns can have 3 effects. Named masterworks.'},
    ]},
};
