...
var RANGER_COMPANIONS=[
  {id:'rc_fox',name:'Cinder Fox',icon:'🦊',region:'ashfields',role:'gatherer',color:'#d08040',
    ...
    primary:{type:'gather',ingr:['ashbloom','char_root','ash_salt','ember_petal'],baseYield:[3,5,7,9,12]},
  ...
  {id:'rc_monkey',name:'Cave Monkey',icon:'🐒',region:'fungal_caves',role:'shopkeeper',color:'#a07050',
    ...
    primary:{type:'shop',baseGold:[5,10,15,20,30]},
  ...
  {id:'rc_hound',name:'Ridge Hound',icon:'🐕',region:'crystal_hollow',role:'greeter',color:'#c09040',
    ...
    primary:{type:'customers',values:[1,1,2,2,3]},
  ...
  {id:'rc_phoenix',name:'Phoenix Hatchling',icon:'🔥',region:'heartforge_rim',role:'legendary',color:'#d4a420',legendary_only:true,
    ...
    primary:{type:'gather',ingr:['phoenix_ash','volcanic_essence','primordial_ash','forge_scale'],baseYield:[3,5,7,9,12]},
  ...
  {id:'rc_sandcat',name:'Dune Cat',icon:'🐈',region:'sunscorch_flats',role:'gatherer',color:'#c0a060',
    ...
    primary:{type:'gather',ingr:['sunpetal','dustite','scorchroot','ash_salt'],baseYield:[3,5,7,9,12]},
  ...
  {id:'rc_sphinx',name:'Desert Sphinx',icon:'🐱',region:'buried_temple',role:'legendary',color:'#d4a420',legendary_only:true,
    ...
    primary:{type:'gather',ingr:['ancient_resin','temple_gold','deep_crystal','mirage_dust'],baseYield:[3,5,7,9,12]},
    secondary:{type:'resurrect',desc:'Once/day: retry a failed craft check',unlockLv:3},
  ...
  {id:'rc_seahawk',name:'Tidecrest Hawk',icon:'🦅',region:'driftwood_shores',role:'scout',color:'#6090b0',
    ...
    primary:{type:'danger_reduce',values:[0.25,0.40,0.50,0.60,0.75]},
    secondary:{type:'discovery',bonusPerLoyalty:0.05,unlockLv:2},
    legendary:'Danger events auto-avoided at Soulbound loyalty'},
  {id:'rc_dolphin',name:'Harbor Dolphin',icon:'🐬',region:'tidal_pools',role:'gather',color:'#40a0d0',
    ...
    primary:{type:'gather',ingr:['coral_shard','pearl_dust','nautilus_shell','sea_amber','deep_coral'],baseYield:[3,5,7,9,12]},
    secondary:{type:'yield',bonusPerLoyalty:0.10,unlockLv:2},
    legendary:'Double yield once per expedition at Soulbound loyalty'},
  {id:'rc_crab',name:'Hermit Crab',icon:'🦀',region:'kelp_forest',role:'muse',color:'#d08060',
    desc:'An enormous hermit crab that follows you around, clicking encouragement.',
    primary:{type:'customers',values:[1,1,2,2,3]},
    secondary:{type:'craft',bonusPerLoyalty:1,unlockLv:3},
    legendary:'+3 craft bonus at Soulbound loyalty'},
  {id:'rc_eel',name:'Fog Hollow Eel',icon:'🐍',region:'fog_hollows',role:'combat',color:'#5a5a7a',
    ...
    secondary:{type:'discovery',bonusPerLoyalty:0.08,unlockLv:2},
    legendary:'Auto-maps one hidden area at Soulbound loyalty'},
  {id:'rc_octopus',name:'Reef Octopus',icon:'🐙',region:'coral_labyrinth',role:'research',color:'#a06080',
    ...
    primary:{type:'research',values:[0.05,0.10,0.15,0.18,0.20]},
    secondary:{type:'craft',bonusPerLoyalty:1,unlockLv:3},
    legendary:'Research auto-discovers at Soulbound loyalty'},
  {id:'rc_seal',name:'Harbor Seal',icon:'🦭',region:'shipwreck_graveyard',role:'trade',color:'#7a7a5a',
    ...
    primary:{type:'customers',values:[1,1,2,2,3]},
    secondary:{type:'yield',bonusPerLoyalty:0.08,unlockLv:2},
    legendary:'Doubles gold from shelf sales at Soulbound loyalty'},
  {id:'rc_leviathan_calf',name:'Leviathan Calf',icon:'🐋',region:'drowned_sanctum',role:'legendary',color:'#2050a0',legendary_only:true,
    ...
    primary:{type:'gather',ingr:['abyssal_pearl','leviathan_scale','tidal_diamond','primordial_brine'],baseYield:[3,5,7,9,12]},
    secondary:{type:'resurrect',desc:'Once/day: retry a failed craft check',unlockLv:3},
    legendary:'Passively generates 1 Drowned Sanctum ingredient every morning'},
];
