...
var CLASSES={
  alchemist:{id:'alchemist',name:'Alchemist',icon:'⚗️',color:TH.green,primaryStat:'inu',
    ...
    features:[
      ...
      {classLv:6,name:'Intuitive DC',desc:'Craft checks can\'t roll below 5. 10% chance for a failed brew (except a natural 1) to succeed anyway — a lucky brew.',effects:{craftFloor:5,luckyBrewChance:0.10}},
      {classLv:7,name:'Master Brewer',desc:'+2 to all craft checks (stacks). +15% research discovery. Mastering this level grants three legendary recipes drawn from the master\'s archive.',effects:{craftBonus:2,discoveryChanceBonus:0.15},grantRecipes:{pool:['celestial_balm','phoenix_draught','forge_catalyst'],count:3}},
      {classLv:8,name:'Reagent Attunement',desc:'Foraging: 30% chance per successful roll to yield a bonus ingredient from your most-brewed recipe (when it grows in that region). +15% ingredient efficiency on all crafts.',effects:{attunedForaging:true,ingredientEfficiency:0.15}},
      ...
      {classLv:10,name:'Magnum Opus',desc:'Your 3 most-brewed recipes auto-succeed at Masterwork quality. +50% double batch chance and 1 free craft per day. Once you have brewed 20 different recipes 25+ times each, one brew per day costs zero ingredients.',effects:{freeCraft:1,doubleBatchChance:0.50,masteryAutoMW:true,zeroIngrMastery:20}},
    ],
    specs:{
      apothecary:{id:'apothecary',name:'Apothecary',desc:'Healers and clinicians. Cure ailments, brew restorative potions, and earn coin treating patients.',mechDesc:'Clinic. Patients arrive daily with ailments that must be diagnosed (Attunement check, DC scales with ailment tier) and treated with the right healing potion. Successful treatments earn XP, coin, and reputation. From Lv6 you also brew one free Healing Salve each morning. Higher Apothecary levels improve diagnosis accuracy: Lv6 grants partial diagnosis even on near-miss rolls, and Lv10 always returns a full diagnosis.',icon:'💊',color:'#50c070',bStat:'inu',bSkills:['attunement','divination'],
        features:[
          {classLv:3,name:"Healer's Touch",desc:'+1 craft bonus on healing recipes specifically. All brews sell for +20%.',effects:{sellBonus:0.20},categoricalBrewBonus:{healing:{craftBonus:1}}},
      ...
      venomist:{id:'venomist',name:'Venomist',desc:'Brew volatile poisons and offensive concoctions. Sell deadly wares to guard factions for premium coin.',mechDesc:'Venom Contracts. Shady clients post poison contracts offering premium coin for specific volatile brews. The Venom Lab on your workshop screen shows available contracts with deadlines and rewards. Craft bonuses scale with level, and failures at Lv10 still produce lesser venoms.',icon:'☠️',color:'#a0d040',bStat:'tec',bSkills:['precision','extraction'],
        features:[
          {classLv:3,name:'Volatile Mixtures',desc:'+2 craft bonus and +30% sell value on all brews. Choosing this spec grants two volatile/explosive recipes.',effects:{sellBonus:0.30,craftBonus:2},grantRecipes:{pool:['magma_flask','obsidian_bomb'],count:2}},
  ...
  enchanter:{id:'enchanter',name:'Enchanter',icon:'✨',color:TH.purple,primaryStat:'tec',
    ...
    shortDesc:'Inscribe runes, premium coin from customers',
    features:[
      ...
      {classLv:4,name:'Arcane Mastery',desc:'+8 flat inscription bonus (flat inscription bonuses cap at +20). See customer satisfaction hints.',effects:{enchantSuccessFlat:8,showCustHints:true}},
      ...
      {classLv:6,name:'Resonance',desc:'Enchanting customers pay 25% more coin. 20% chance to save enchanting materials. Mastering this level grants two resonance-themed enchantment patterns.',effects:{enchantGoldBonus:0.25,enchantMatSave:0.20},grantEnchants:{pool:['e_echo_strike','e_runespark'],count:2}},
      {classLv:7,name:'Overcharge',desc:'Natural 20 on an inscription roll produces a Masterwork enchantment (2× XP and Masterwork-tier pricing).',effects:{masterworkOnCrit:true}},
      ...
      {classLv:9,name:'Rune Library',desc:'A vast personal archive accelerates your research. +25% discovery chance and +10% XP from all sources.',effects:{discoveryChanceBonus:0.25,xpMultiplier:0.10}},
      {classLv:10,name:'Reality Weaver',desc:'Inscription mastery: +12 flat bonus, +50% coin from enchanting. Crits on 17+.',effects:{enchantSuccessFlat:12,enchantGoldBonus:0.50,enchantCritRange:17}},
    ],
    specs:{
      runesmith:{id:'runesmith',name:'Runesmith',desc:'Forge powerful weapon enchantments. Martial runes command top prices from warriors and adventurers.',mechDesc:'Runesmith Forge. A dedicated forging station appears in your workshop where you can craft magical weapons. Each day you get a limited number of forge uses (1 at Lv3, scaling to 3 at Lv10). Forged weapons sell at premium prices and weapon enchantments get bonus value.',icon:'⚔️',color:'#d08040',bStat:'tec',bSkills:['inscription','refinement'],
        features:[
          {classLv:3,name:'Battle Runes',desc:'+1 inscription bonus and +15% coin on weapon enchantments specifically.',effects:{},categoricalEnchantBonus:{weapon:{enchantBonus:1,enchantGoldBonus:0.15}}},
          {classLv:6,name:'Runic Mastery',desc:'All enchantment material costs -1. Inscription crits on 19+. Once per day you can reroll a failed craft or inscription.',effects:{enchantMatDiscount:1,enchantCritRange:19,craftReroll:1}},
          {classLv:10,name:'Legendary Arms',desc:'+50% coin on weapon enchantments specifically. Inscriptions auto-succeed at DC 14 or below, and natural-20 crits produce Masterwork enchantments.',effects:{masterworkOnCrit:true,autoEnchantDC:14},categoricalEnchantBonus:{weapon:{enchantGoldBonus:0.50}}},
        ]},
      wardkeeper:{id:'wardkeeper',name:'Wardkeeper',desc:'Specialize in defensive enchantments. Layer protective wards for lucrative shield commissions.',mechDesc:'Shield Commissions. Defensive enchantment orders arrive from clients needing warded armor and shields. The commission system tracks your active orders with deadlines. Inscription bonuses stack for defensive work, and at Lv10 permanent wards auto-succeed at DC 15.',icon:'🛡️',color:'#4080d0',bStat:'dis',bSkills:['focus','endurance'],
        features:[
          {classLv:3,name:'Wards',desc:'+1 inscription bonus on armor enchantments specifically. Failed inscriptions of any kind return 50% of their materials.',effects:{failEnchantReturn:0.50},categoricalEnchantBonus:{armor:{enchantBonus:1}}},
          ...
          {classLv:10,name:'Unbreakable',desc:'Auto-succeed inscriptions at DC 15 or below. +10 flat inscription bonus. 60% chance to save materials on a successful inscription. Shield commissions pay 3× coin. A permanent Fortress Ward protects your shelves: bandits cannot steal overnight shelf sales while local bandit threat stays below 75.',effects:{autoEnchantDC:15,enchantSuccessFlat:10,enchantMatSave:0.60,shieldPayMult:3,fortressWard:true}},
        ]},
      spellweaver:{id:'spellweaver',name:'Spellweaver',desc:'Craft exotic utility enchantments and tap into planar power sources. Attract rare, high-paying customers.',mechDesc:'Planar Attunement. Attune to one of four extraplanar sources via the Planar Focus interface for 1 day (2 days from Lv6). Each plane delivers a real tradeoff — boons paired with costs: Feywild gives +30% coin on accessory/utility ("other") enchants but a 10% per-success chance of a dissatisfied customer (−1g refund and −1 to your aligned faction\'s rep); Shadowfell gives +2 inscription on armor enchants but +3 DC on weapon enchants; Elemental Chaos triggers a 20% per-success planar surge (+50% coin and +50% XP) but failed inscriptions destroy all materials; Astral Sea reduces DC by 2 on all enchants but pays 15% less coin. Standard Spellweaver bonuses focus on the "other" enchantment category (accessory/utility inscriptions: rings, cloaks, charms): +1 inscription at Lv3, +35% coin and +1 customer slot at Lv6. At Lv10, Planar Convergence unlocks — attune a second plane while the first is still active, fusing them into a combo (Twilight Veil, Wild Magic, Dreamweave, Void Storm, Null Space, or Primordial Order). The combo\'s effects replace both planes\' individual effects — convergence is a mode switch, not additive stacking. Lv10 also grants inscription crits on 17+, +50% coin from enchanting overall, and +30% coin from potion customers.',icon:'🌀',color:'#a060e0',bStat:'inu',bSkills:['arcane_sense','divination'],
        features:[
          ...
          {classLv:6,name:'Planar Weave',desc:'+35% coin on accessory/utility ("other"-category) enchantments specifically. +1 daily customer slot.',effects:{customerBonus:1},categoricalEnchantBonus:{other:{enchantGoldBonus:0.35}}},
          {classLv:10,name:'Planar Convergence',desc:'Inscription crits on 17+. +50% coin from enchanting. +30% coin from potion customers (planar patronage attracts wealthy clientele).',effects:{enchantCritRange:17,enchantGoldBonus:0.50,customerPayBonus:0.30}},
        ]},
    }},
  artificer:{id:'artificer',name:'Artificer',icon:'⚙️',color:TH.orange,primaryStat:'tec',
    ...
    features:[
      {classLv:1,name:'Technical Crafting',desc:'+1 to all craft checks and 15% salvage on failures. Gain proficiency in Precision and Refinement.',effects:{craftBonus:1,salvagePercent:0.15}},
      ...
      {classLv:4,name:'Calibration',desc:'+1 to all craft checks. Your d20 craft rolls cannot land below 4 — tightly calibrated technique.',effects:{craftFloor:4,craftBonus:1}},
      {classLv:5,name:'Overclock',desc:'Workshop upgrade costs reduced by 20%. Batch brew capacity +1.',effects:{upgradeCostReduction:0.20,batchSizeBonus:1}},
      ...
      {classLv:9,name:'Systematic Mastery',desc:'Batch brew cap +3. +15% batch brew success rate. All batch brews show individual roll results.',effects:{batchSizeBonus:3,batchSuccessBonus:0.15}},
    ...
    specs:{
      ...
      constructor:{id:'constructor',name:'Constructor',desc:'Master workshop builder. Upgrades cost less, staff work harder, and legendary blueprints reshape production.',mechDesc:'Blueprint Drafting. Draft and build custom workshop structures from blueprints. Each blueprint requires a drafting phase (research) followed by a construction phase (staff assignment). Completed blueprints provide unique workshop bonuses not available through normal upgrades.',icon:'🏗️',color:'#8090a0',bStat:'dis',bSkills:['endurance','precision'],
        features:[
          {classLv:3,name:'Workshop Pro',desc:'Workshop upgrades cost 50% less coin. Staff efficiency +15%.',effects:{upgradeCostReduction:0.5,staffEfficiencyBonus:0.15}},
      ...
      reclaimer:{id:'reclaimer',name:'Reclaimer',desc:'Waste nothing. Salvage failed brews, break down items for materials, and turn spoilage into profit.',mechDesc:'Salvage System. Failed brews and enchantments return a percentage of ingredients instead of losing everything. The salvage rate increases with level (75% at Lv3, 100% at Lv10). At Lv6 you can deconstruct finished potions back into ingredients. Spoiled ingredients produce Alchemical Residue.',icon:'♻️',color:'#60a080',bStat:'dis',bSkills:['endurance','precision'],
        features:[
          {classLv:3,name:'Zero Waste',desc:'75% salvage on craft failure. +25% ingredient efficiency. 50% of spoiled ingredients are reclaimed as Alchemical Residue instead of being lost.',effects:{salvagePercent:0.75,ingredientEfficiency:0.25,spoilSalvage:0.50}},
          {classLv:6,name:'Deconstruct',desc:'Failed enchantments return 100% of their materials. 30% chance to save an ingredient on any successful brew.',effects:{failEnchantReturn:1.0,saveIngredientChance:0.30}},
          {classLv:10,name:'Perfect Reclamation',desc:'One free craft per day (no ingredients consumed). 100% salvage on craft failures — nothing is ever wasted.',effects:{freeCraft:1,salvagePercent:1.0}},
        ]},
    }},
  scholar:{id:'scholar',name:'Scholar',icon:'📚',color:TH.cyan,primaryStat:'acu',
    ...
    features:[
      {classLv:1,name:'Research Study',desc:'Can conduct research studies to discover recipes. Gain proficiency in Research and Analysis. +5% discovery chance, +5% XP from all sources.',effects:{discoveryChanceBonus:0.05,xpMultiplier:0.05}},
      ...
      {classLv:7,name:'Thesis Defense',desc:'A defended thesis sharpens every line of inquiry. +3 craft bonus, +15% discovery chance, +10% XP from all sources.',effects:{craftBonus:3,discoveryChanceBonus:0.15,xpMultiplier:0.10}},
      {classLv:8,name:'Grand Theorem',desc:'+25% discovery chance from all sources. +1 free research action per day on top of all other sources.',effects:{discoveryChanceBonus:0.25,researchSlotBonus:1}},
    ...
    specs:{
      ...
      archivist:{id:'archivist',name:'Archivist',desc:'Pursue lore fragments and quest chains. Board quests refresh faster, and deep knowledge grants permanent stats.',mechDesc:'Lore Fragments. Discover ancient lore fragments during quests and research. Fragments form chains that, when completed, grant permanent passive bonuses. The Lore Archive tracks your collection and shows incomplete chains. Board quests refresh more often and reward bonus reputation.',icon:'📜',color:'#c0a060',bStat:'dis',bSkills:['research','focus'],
        features:[
          {classLv:3,name:'Deep Records',desc:'+30% XP from quest turn-ins, and +5× the standard faction-rep payout on quests.',effects:{questRepBonus:5,questXPBonus:0.30}},
          {classLv:6,name:'Master Index',desc:'The notice board refreshes twice as often (more quests per cycle). +25% coin from quest turn-ins.',effects:{doubleQuestRefresh:true,questGoldBonus:0.25}},
  ...
  warden:{id:'warden',name:'Warden',icon:'🛡️',color:TH.teal,primaryStat:'dis',
    ...
    features:[
      {classLv:1,name:'Trailblazer',desc:'Travel Energy cost -25% to all regions. Gain proficiency in Extraction and Endurance.',effects:{energyCostMultiplier:{travel:-0.25}}},
      ...
      {classLv:4,name:'Iron Constitution',desc:'Immune to expedition events that cost Energy. Power through danger.',effects:{immuneTimeLossEvents:true}},
    ...
    specs:{
      ranger:{id:'ranger',name:'Ranger',desc:'Tame wild companions that gather, sell, scout, and fight alongside you. The signature beast-bond spec.',mechDesc:'Wild Companions. Befriend wild creatures during foraging expeditions. Companions perform daily actions: gathering ingredients, earning coin, scouting, greeting customers, guarding, or inspiring research. Loyalty grows over time, unlocking secondary abilities and legendary powers. At Lv10, companions perform all actions twice, gain type-specific legendary abilities, and can be sent on solo expeditions from their card.',icon:'🏹',color:'#40a060',bStat:'inu',bSkills:['danger_sense','divination'],
        features:[
          ...
          {classLv:6,name:'Pathfinder',desc:'+50% foraging yield. Critical extractions (nat 20) yield an additional +2× ingredients on top of the base crit multiplier.',effects:{yieldMultiplier:0.50,critExtractionMulti:2}},
          {classLv:10,name:'Apex Predator',desc:'Companions perform all actions twice per day. Your highest-loyalty companion (★5) gains a Legendary ability unique to its role: Foragers find rare ingredients, Merchants attract VIPs, Greeters earn referral coin, Guardians heal staff injuries, Muses grant bonus Energy, Scouts negate all expedition danger. Send any companion on a solo expedition from their card (1/day, 0 Energy).',effects:{companionDualAction:true,guaranteedRare:true,legendaryCompanion:true,soloExpedition:true}},
        ]},
...
var FEATS={
  ...
  master_presenter:{id:'master_presenter',name:'Master Presenter',icon:'🏆',cat:'economic',desc:'+2s per potion sale.',effects:{potionSaleBonus:2},req:{feat:'artisans_touch'}},
  ...
  quick_study:{id:'quick_study',name:'Quick Study',icon:'⏱️',cat:'economic',desc:'Research Energy cost -25%.',effects:{energyCostMultiplier:{research:-0.25}},req:{feat:'scholars_memory'}},
  keen_eye:{id:'keen_eye',name:'Keen Eye',icon:'👁️',cat:'economic',desc:'+3s per enchant commission.',effects:{enchantGoldFlat:3}},
  gem_cutter:{id:'gem_cutter',name:'Gem Cutter',icon:'💠',cat:'economic',desc:'+1s per ingredient sold.',effects:{ingrSellBonus:1}},
  ...
  // ── Legacy ──
  ancestral_wisdom:{id:'ancestral_wisdom',name:'Ancestral Wisdom',icon:'🕯️',cat:'legacy',desc:'Pass the Torch carries 25% coin (up from 15%), 5 recipes (up from 3), 50% rep (up from 33%). +25 Energy.',effects:{torchGoldBonus:0.10,torchRecipeBonus:2,torchRepBonus:0.17,torchEnergyBonus:25}},
  // ── Combat/Survival ──
...
var UPGRADES={
  ...
  shopfront:{id:'shopfront',name:'Shop Front',icon:'🪟',cat:'Business',desc:'+5s/day passive.',cost:{gold:40,ironroot_bark:4},effect:{passiveIncome:5},tier:1,req:null},
...
var TASK_TYPES={
  ...
  shopkeep:{name:'Shop',icon:'🏪',stat:'inu',desc:'Tends the shop counter, earning coin based on level and INU stat. Reliable daily income.'},
  ...
  construct:{name:'Construct',icon:'🔨',stat:'dis',desc:'Preps a workshop upgrade overnight. Higher DIS = faster progress. When complete, coin cost -40% and one material requirement waived.'},
...
var REGIONS=[
  ...
  {id:'fungal_caves',loc:'cindervale',name:'Fungal Caves',icon:'🍄',color:'#3a2a3a',ingr:['embercap','gloomcap','spore_dust','cave_lichen','biolumen_gel','mycelium_thread','echo_fungus','ghost_silk','harmonic_crystal','resonance_dust'],pick:3,sites:[
    ...
    ],diff:2,unlock:2,time:15,yield:[2,4],dc:11,
  ...
  {id:'crystal_hollow',loc:'cindervale',name:'Crystal Hollows',icon:'💎',color:'#2a3a4a',ingr:['hearthstone','ashite','crystal_shard','mineral_clay','geode_dust','resonance_ore','singing_quartz','copper_vein','crystal_mycelium','deep_pearl'],pick:3,sites:[
    ...
    ],diff:3,unlock:3,time:20,yield:[2,4],dc:13,
  ...
  {id:'moonlit_glade',loc:'cindervale',name:'Moonlit Glade',icon:'🌙',color:'#2a2a4a',ingr:['moonpetal','starwort','nightdew','lunar_moss','dew_crystal','silver_lichen','moth_scale','dream_pollen','veil_shard','silver_lotus','liquid_moonlight','frostbloom'],pick:3,sites:[
    ...
    ],diff:3,unlock:4,time:25,yield:[2,4],dc:14,
  ...
  {id:'volcanic_vents',loc:'cindervale',name:'Volcanic Vents',icon:'🌋',color:'#4a2a1a',ingr:['volcanic_essence','embervein','sulfur_bloom','magma_salt','obsidian_flake','thermal_clay','lava_pearl','pyrestone','sacred_ember'],pick:3,sites:[
    ...
    ],diff:4,unlock:5,time:30,yield:[2,4],dc:15,
  ...
  {id:'deep_mines',loc:'cindervale',name:'Deep Mines',icon:'⛏️',color:'#3a3a40',ingr:['ashite','hearthstone','embervein','deep_iron','shadow_quartz','echo_stone','dark_amber','mithril_dust','void_salt','deep_crystal','ice_crystal','deep_mithril','shadow_ore'],pick:3,sites:[
    ...
    ],diff:4,unlock:6,time:35,yield:[2,4],dc:16,faction:'cinderfolk',fReq:2,
  ...
  {id:'heartforge_rim',loc:'cindervale',name:'Heartforge Rim',icon:'⚡',color:'#4a3a0a',ingr:['volcanic_essence','hearthstone','embervein','starwort','forge_scale','primordial_ash','phoenix_ash','runespark','heartstone_sliver','titan_bone','moonwell_water','primordial_spark'],pick:3,sites:[
    ...
    ],diff:5,unlock:8,time:40,yield:[2,4],dc:18,
  ...
  {id:'oasis_grove',loc:'ashfall',name:'Oasis Grove',icon:'🌴',color:'#3a6a4a',
    ...
    ],diff:3,unlock:4,time:25,yield:[2,4],dc:14,faction:'flamekeepers',fReq:1,
  ...
  {id:'mirage_bazaar',loc:'ashfall',name:'Mirage Bazaar',icon:'🏜️',color:'#5a3a6a',
    ...
    ],diff:4,unlock:6,time:35,yield:[2,4],dc:16,faction:'dustwalkers',fReq:2,
  ...
  {id:'kelp_forest',loc:'tidecrest',name:'Kelp Forest',icon:'🌊',color:'#2a5a4a',
    ...
    ],diff:2,unlock:2,time:15,yield:[2,4],dc:12,
  ...
  {id:'fog_hollows',loc:'tidecrest',name:'Fog Hollows',icon:'🌫️',color:'#5a5a7a',
    ...
    ],diff:3,unlock:3,time:20,yield:[2,4],dc:14,
  ...
  {id:'coral_labyrinth',loc:'tidecrest',name:'Coral Labyrinth',icon:'🐚',color:'#6a3a5a',
    ...
    ],diff:3,unlock:4,time:25,yield:[2,4],dc:15,faction:'pearl_divers',fReq:1,
  ...
  {id:'shipwreck_graveyard',loc:'tidecrest',name:'Shipwreck Graveyard',icon:'⚓',color:'#4a4a3a',
    ...
    ],diff:4,unlock:5,time:30,yield:[2,4],dc:16,
  ...
  {id:'abyssal_trench',loc:'tidecrest',name:'Abyssal Trench',icon:'🦑',color:'#1a2a4a',
    ...
    ],diff:4,unlock:6,time:35,yield:[2,4],dc:17,faction:'harbormasters',fReq:2,
  ...
  {id:'sky_ruins',loc:'skyreach',name:'Sky Ruins',icon:'🏯',color:'#5a4a6a',
    ...
    ],diff:4,unlock:6,time:35,yield:[2,4],dc:16,faction:'starcallers',fReq:2,
...
var RECIPES=[
  {id:'healing_salve',name:'Healing Salve',icon:'🧴',ingr:['ashbloom','hearthstone'],xp:30,unlock:0,dc:8,stat:'inu',cat:'healing',desc:'A soothing balm that knits flesh and eases pain — the backbone of any apothecary.'},
  {id:'ash_poultice',name:'Ash Poultice',icon:'🩹',ingr:['ash_salt','cinder_moss'],xp:25,unlock:0,dc:7,stat:'inu',cat:'healing',desc:'A rough but effective field dressing. Cinder moss draws toxins while ash salt seals wounds.'},
  {id:'firebrew',name:'Firebrew',icon:'🧪',ingr:['embercap','volcanic_essence'],xp:45,unlock:2,dc:11,stat:'tec',cat:'buff',desc:'Liquid courage that burns going down and burns coming out. The Ashwardens swear by it.'},
  {id:'enchanters_ink',name:"Enchanter's Ink",icon:'✒️',ingr:['moonpetal','hearthstone'],xp:50,unlock:3,dc:12,stat:'acu',cat:'material',desc:'Silvery ink that holds arcane charge — essential for inscribing runes and wards.'},
  {id:'ironhide',name:'Ironhide Potion',icon:'🛡️',ingr:['ironroot_bark','volcanic_essence'],xp:50,unlock:3,dc:12,stat:'tec',cat:'buff',desc:'Toughens skin to leather. Miners drink it before entering unstable shafts.'},
  {id:'ashveil',name:'Ashveil Tonic',icon:'👁️',ingr:['ashbloom','moonpetal'],xp:40,unlock:2,dc:10,stat:'inu',cat:'utility',desc:'Sharpens sight through ash and darkness. Scouts pay well for this.'},
  {id:'thornbark_tonic',name:'Thornbark Tonic',icon:'🌿',ingr:['thornvine','ironwood_sap'],xp:40,unlock:2,dc:10,stat:'tec',cat:'buff',desc:'Ironwood sap mixed with thornvine creates a bark-like layer on the skin. Short-lived but effective.'},
  {id:'spore_bomb',name:'Spore Bomb',icon:'💣',ingr:['spore_dust','embercap'],xp:45,unlock:2,dc:11,stat:'cre',cat:'damage',desc:'A volatile mixture that erupts in a cloud of disorienting spores. Scouts use them to cover retreats.'},
  {id:'gloom_draught',name:'Gloom Draught',icon:'🫧',ingr:['gloomcap','moonpetal'],xp:55,unlock:4,dc:13,stat:'inu',cat:'utility',desc:'Distilled shadows that let the drinker pass unseen through the wilds.'},
  {id:'crystal_lens',name:'Crystal Lens Elixir',icon:'🔷',ingr:['crystal_shard','mineral_clay'],xp:55,unlock:3,dc:12,stat:'acu',cat:'utility',desc:'Sharpens perception to an unnatural degree. Users report seeing the weave of magic itself.'},
  {id:'moonweave',name:'Moonweave Elixir',icon:'💧',ingr:['nightdew','lunar_moss'],xp:60,unlock:4,dc:13,stat:'inu',cat:'buff',desc:'Brewed under moonlight, it amplifies arcane potential. Enchanters covet this.'},
  {id:'magma_flask',name:'Magma Flask',icon:'🧨',ingr:['sulfur_bloom','magma_salt'],xp:70,unlock:5,dc:14,stat:'tec',cat:'damage',desc:'Concentrated volcanic fury in a bottle. Shatters on impact with devastating heat.'},
  {id:'embersteel_oil',name:'Embersteel Oil',icon:'⚙️',ingr:['embervein','ironroot_bark','ashite'],xp:75,unlock:6,dc:15,stat:'tec',cat:'material',desc:'Applied to weapons, it makes steel burn with the heat of the deep earth.'},
  {id:'shadow_draught',name:'Shadow Draught',icon:'🖤',ingr:['shadow_quartz','deep_iron'],xp:75,unlock:6,dc:15,stat:'inu',cat:'utility',desc:'Distilled from deep mine darkness. The drinker becomes one with shadow.'},
  {id:'deepsteel_polish',name:'Deepsteel Polish',icon:'⬛',ingr:['deep_iron','embervein','mineral_clay'],xp:80,unlock:6,dc:16,stat:'tec',cat:'material',desc:'A weapon treated with this polish cuts through armor as if it were cloth.'},
  {id:'celestial_balm',name:'Celestial Balm',icon:'✨',ingr:['starwort','moonpetal','hearthstone'],xp:90,unlock:7,dc:17,stat:'inu',cat:'healing',desc:'Rare and precious — this balm can cure ailments beyond mortal medicine.'},
  {id:'forgeheart_tincture',name:'Forgeheart Tincture',icon:'💜',ingr:['forge_scale','primordial_ash','hearthstone'],xp:110,unlock:8,dc:19,stat:'cre',cat:'buff',desc:'Essence of the Heartforge itself. Grants brief but immense resistance to all harm.'},
  {id:'forge_catalyst',name:'Forge Catalyst',icon:'⚡',ingr:['embercap','hearthstone','volcanic_essence'],xp:120,unlock:9,dc:20,stat:'cre',cat:'material',desc:'The legendary compound that could reignite the Heartforge itself.'},
  {id:'warden_ward',name:'Warden\'s Ward',icon:'🔰',ingr:['warden_sigil','ironroot_bark','hearthstone'],xp:100,unlock:6,dc:15,stat:'dis',faction:'ashwardens',fReq:2,cat:'utility',desc:'Ashwarden patrol wards — planted along roads to repel creatures from the vents.'},
  {id:'holy_flame',name:'Holy Flame',icon:'🕯️',ingr:['sacred_ember','ashbloom','starwort'],xp:100,unlock:6,dc:15,stat:'inu',faction:'hearthkeepers',fReq:3,cat:'healing',desc:'A sacred fire that purifies corruption and lights the way for the faithful.'},
  {id:'veil_sight',name:'Veil Sight',icon:'🔮',ingr:['veil_shard','moonpetal','gloomcap'],xp:100,unlock:6,dc:15,stat:'inu',faction:'veilwalkers',fReq:3,cat:'utility',desc:'Opens the drinker\'s eyes to things hidden between the folds of reality.'},
  // New recipes using expanded ingredients
  {id:'windwalk_salve',name:'Windwalk Salve',icon:'🌬️',ingr:['wind_dust','char_root'],xp:20,unlock:0,dc:7,stat:'inu',cat:'utility',desc:'A light balm that eases breathing in ash-heavy air. Popular with field workers.'},
  {id:'bark_shield',name:'Barkskin Paste',icon:'🛡️',ingr:['bark_resin','moss_amber'],xp:35,unlock:1,dc:9,stat:'tec',cat:'buff',desc:'Ironwood resin hardens into a temporary armor layer when spread on skin.'},
  {id:'glow_vial',name:'Glow Vial',icon:'💚',ingr:['biolumen_gel','cave_lichen'],xp:40,unlock:2,dc:10,stat:'cre',cat:'utility',desc:'Bottled bioluminescence. Sheds soft green light for hours without flame or heat.'},
  {id:'mycelium_wrap',name:'Mycelium Bandage',icon:'🩹',ingr:['mycelium_thread','spore_dust'],xp:38,unlock:2,dc:10,stat:'tec',cat:'healing',desc:'Living fungal fibers that bond with flesh, sealing wounds and fighting infection.'},
  {id:'geode_tonic',name:'Geode Tonic',icon:'🔹',ingr:['geode_dust','resonance_ore'],xp:52,unlock:3,dc:12,stat:'acu',cat:'buff',desc:'Crystalline mineral water that sharpens the mind to a razor edge.'},
  {id:'resonance_oil',name:'Resonance Oil',icon:'🔔',ingr:['resonance_ore','crystal_shard'],xp:55,unlock:3,dc:13,stat:'tec',cat:'utility',desc:'Vibrating oil that reveals stress fractures in metal. Blacksmiths covet this.'},
  {id:'moonmist',name:'Moonmist Elixir',icon:'🌙',ingr:['dew_crystal','silver_lichen'],xp:58,unlock:4,dc:13,stat:'inu',cat:'buff',desc:'Captures moonlight in liquid form. Grants ethereal calm and sharpened senses.'},
  {id:'silver_salve',name:'Silver Salve',icon:'🤍',ingr:['silver_lichen','nightdew'],xp:55,unlock:4,dc:12,stat:'inu',cat:'healing',desc:'A pale ointment with mild anti-corruption properties. The Hearthkeepers approve.'},
  {id:'obsidian_bomb',name:'Obsidian Bomb',icon:'💣',ingr:['obsidian_flake','thermal_clay'],xp:68,unlock:5,dc:14,stat:'cre',cat:'damage',desc:'Volcanic glass packed in heat-retaining clay. Shatters into a storm of razor shards.'},
  {id:'thermal_potion',name:'Thermal Draught',icon:'🟠',ingr:['thermal_clay','sulfur_bloom'],xp:65,unlock:5,dc:14,stat:'tec',cat:'buff',desc:'Heats the drinker from within. Essential for survival in the frozen deep mines.'},
  {id:'echo_elixir',name:'Echo Elixir',icon:'🔊',ingr:['echo_stone','dark_amber'],xp:78,unlock:6,dc:15,stat:'acu',cat:'utility',desc:'Grants echolocation-like perception. Users can sense movement through solid stone.'},
  {id:'dark_ward',name:'Dark Ward Oil',icon:'🟤',ingr:['dark_amber','shadow_quartz'],xp:80,unlock:6,dc:16,stat:'dis',cat:'utility',desc:'Wards against creatures of the deep. Miners won\'t enter Shaft Nine without it.'},
  {id:'phoenix_draught',name:'Phoenix Draught',icon:'🔥',ingr:['phoenix_ash','primordial_ash','hearthstone'],xp:115,unlock:8,dc:19,stat:'cre',cat:'healing',desc:'Legend says this draught can pull the drinker back from the brink of death itself.'},
  {id:'runespark_ink',name:'Runespark Ink',icon:'✨',ingr:['runespark','forge_scale','moonpetal'],xp:120,unlock:8,dc:19,stat:'acu',cat:'material',desc:'Living ink that writes itself into runes of immense power. The finest enchanting medium.'},
  // Wave 2 recipes — using expansion ingredients
  {id:'soot_candle',name:'Soot Candle',icon:'🕯️',ingr:['soot_crystal','ember_petal'],xp:20,unlock:0,dc:7,stat:'cre',cat:'utility',desc:'A slow-burning candle that purifies ash-heavy air. Every Cindervale home has one.'},
  {id:'amber_varnish',name:'Amber Varnish',icon:'🍯',ingr:['amber_sap','beetle_shell'],xp:35,unlock:1,dc:9,stat:'tec',cat:'material',desc:'Golden lacquer from Ironwood sap and ground beetle shell. Protects against corrosion.'},
  {id:'spectral_tincture',name:'Spectral Tincture',icon:'👻',ingr:['ghost_silk','echo_fungus'],xp:42,unlock:2,dc:11,stat:'inu',cat:'utility',desc:'Distilled cave spider silk and echo fungus. Allows the drinker to perceive spirits briefly.'},
  {id:'resonance_draught',name:'Resonance Draught',icon:'🎵',ingr:['singing_quartz','copper_vein'],xp:55,unlock:3,dc:12,stat:'acu',cat:'utility',desc:'Crystal vibrations in liquid form. Heightens awareness to detect hidden doors and traps.'},
  {id:'dream_dust',name:'Dream Dust',icon:'💤',ingr:['dream_pollen','moth_scale'],xp:60,unlock:4,dc:13,stat:'inu',cat:'utility',desc:'Powdered moonlit moth scales mixed with narcotic pollen. Induces vivid prophetic dreams.'},
  {id:'pyrestone_flask',name:'Pyrestone Flask',icon:'🟧',ingr:['pyrestone','lava_pearl'],xp:70,unlock:5,dc:14,stat:'tec',cat:'damage',desc:'Concentrated volcanic heat in crystal form. Can melt through locked iron gates.'},
  {id:'void_essence',name:'Void Essence',icon:'🟪',ingr:['void_salt','mithril_dust'],xp:82,unlock:6,dc:16,stat:'dis',cat:'utility',desc:'Distilled absence. Renders the drinker undetectable to magical scrying for a full day.'},
  {id:'titan_elixir',name:'Titan\'s Elixir',icon:'🦴',ingr:['titan_bone','heartstone_sliver','forge_scale'],xp:115,unlock:8,dc:19,stat:'cre',cat:'buff',desc:'Ground bones of ancient creatures mixed with Heartforge fragments. Grants immense but temporary strength.'},
  // ═══ CARTOGRAPHER ELIXIRS — require hidden ingredients, grant multi-day buffs ═══
  {id:'prismatic_elixir',name:'Prismatic Elixir',icon:'🌈',ingr:['prismatic_ash','thermal_bloom','ashbloom'],xp:80,unlock:5,dc:14,stat:'inu',cat:'buff',desc:'Shimmering brew from Ash Geyser reagents. Enhances all crafting for 3 days.',buff:'prismatic_elixir'},
  {id:'canopy_draught',name:'Canopy Draught',icon:'🍃',ingr:['canopy_moss','sky_amber','ironroot_bark'],xp:80,unlock:5,dc:14,stat:'inu',cat:'buff',desc:'Distilled sunlight from the forest crown. Boosts foraging for 3 days.',buff:'canopy_draught'},
  {id:'deep_pearl_tonic',name:'Deep Pearl Tonic',icon:'🫧',ingr:['crystal_mycelium','deep_pearl','embercap'],xp:90,unlock:5,dc:15,stat:'acu',cat:'buff',desc:'Iridescent cave pearl liquid. Sharpens discovery and learning for 3 days.',buff:'deep_pearl_tonic'},
  {id:'harmonic_infusion',name:'Harmonic Infusion',icon:'🔔',ingr:['harmonic_crystal','resonance_dust','hearthstone'],xp:90,unlock:6,dc:15,stat:'cre',cat:'buff',desc:'Crystal resonance in liquid form. Massively boosts enchanting for 3 days.',buff:'harmonic_infusion'},
  {id:'moonlight_philter',name:'Moonlight Philter',icon:'🌙',ingr:['liquid_moonlight','silver_lotus','moonpetal'],xp:95,unlock:6,dc:16,stat:'inu',cat:'buff',desc:'Bottled moonbeams. Everything you sell is worth more for 4 days.',buff:'moonlight_philter'},
  {id:'magma_essence',name:'Magma Essence',icon:'🔥',ingr:['magma_diamond','living_ember','volcanic_essence'],xp:100,unlock:7,dc:17,stat:'tec',cat:'buff',desc:'Liquid fire. Incredibly potent but short-lived crafting power for 2 days.',buff:'magma_essence'},
  {id:'mithril_draught',name:'Mithril Draught',icon:'⚪',ingr:['deep_mithril','shadow_ore','embervein'],xp:100,unlock:7,dc:17,stat:'tec',cat:'buff',desc:'The rarest metal dissolved. Your hands become instruments of precision for 3 days.',buff:'mithril_draught'},
  {id:'primordial_elixir',name:'Primordial Elixir',icon:'⚡',ingr:['primordial_spark','forge_heart_shard','phoenix_ash'],xp:150,unlock:8,dc:20,stat:'inu',cat:'buff',desc:'Creation energy in a flask. The ultimate elixir — boosts everything for 5 days.',buff:'primordial_elixir'},
  // ═══ ASHFALL CROSSING RECIPES ═══
  {id:'sunstroke_tonic',name:'Sunstroke Tonic',icon:'☀️',ingr:['sunpetal','crystal_salt'],dc:8,xp:40,stat:'inu',unlock:0,cat:'healing',desc:'Restores energy sapped by desert heat.'},
  {id:'sandveil_draught',name:'Sandveil Draught',icon:'🏜️',ingr:['dustite','sunpetal','scorchroot'],dc:10,xp:55,stat:'tec',unlock:1,cat:'utility',desc:'Renders the drinker nearly invisible in sandstorms.'},
  {id:'obsidian_edge_oil',name:'Obsidian Edge Oil',icon:'🖤',ingr:['obsidian_shard','scorchroot'],dc:11,xp:60,stat:'tec',unlock:2,cat:'material',desc:'Weapon oil that gives blades a volcanic glass edge.'},
  {id:'brine_poultice',name:'Brine Poultice',icon:'🧂',ingr:['crystal_salt','brine_moss','sunpetal'],dc:10,xp:50,stat:'inu',unlock:1,cat:'healing',desc:'Salt-based wound treatment.'},
  {id:'sandsilk_salve',name:'Sandsilk Salve',icon:'🕸️',ingr:['sandsilk','dewdrop_lily'],dc:13,xp:75,stat:'inu',unlock:3,cat:'healing',desc:'Luxurious healing cream prized by nobles.'},
  {id:'venom_antidote',name:'Venom Antidote',icon:'🐍',ingr:['venomgland','dewdrop_lily','crystal_salt'],dc:14,xp:80,stat:'acu',unlock:3,cat:'healing',desc:'Neutralizes the deadliest desert venoms.'},
  {id:'mirage_elixir',name:'Mirage Elixir',icon:'✨',ingr:['mirage_dust','dewdrop_lily','sandsilk'],dc:16,xp:100,stat:'inu',unlock:5,cat:'utility',desc:'Grants brief glimpses of hidden things.'},
  {id:'desert_iron_flask',name:'Desert Iron Flask',icon:'⚱️',ingr:['obsidian_shard','heatstone','crystal_salt'],dc:15,xp:90,stat:'tec',unlock:4,cat:'utility',desc:'Unbreakable container that preserves any liquid.'},
  {id:'temple_restoration',name:'Temple Restoration',icon:'🏛️',ingr:['temple_gold','ancient_resin','flamekeeper_ember'],dc:18,xp:140,stat:'acu',unlock:7,cat:'utility',desc:'Repairs ancient artifacts. Immensely valuable.'},
  {id:'oasis_blessing',name:'Oasis Blessing',icon:'💧',ingr:['dewdrop_lily','flamekeeper_ember','moonpetal','mirage_dust'],dc:20,xp:180,stat:'inu',unlock:8,cat:'healing',desc:'Legendary desert restorative.'},

  // ═══ ASHFALL EXPANSION RECIPES ═══
  {id:'dust_shield',name:'Dust Shield Potion',icon:'☕',ingr:['dustite','ashbloom'],dc:8,xp:40,stat:'tec',unlock:0,cat:'buff',desc:'Coats the skin in hardened dust. Blocks minor abrasions.'},
  {id:'salt_tonic',name:'Salt Tonic',icon:'🧂',ingr:['crystal_salt','sunpetal'],dc:9,xp:45,stat:'inu',unlock:0,cat:'healing',desc:'Restores electrolytes lost in desert heat.'},
  {id:'scorchroot_tea',name:'Scorchroot Tea',icon:'🫖',ingr:['scorchroot','ashbloom'],dc:9,xp:45,stat:'inu',unlock:1,cat:'buff',desc:'Bitter brew that sharpens the mind in scorching conditions.'},
  {id:'ember_ink',name:'Ember Ink',icon:'🩶',ingr:['embervein','dustite'],dc:11,xp:55,stat:'tec',unlock:2,cat:'material',desc:'Heat-resistant ink used for inscription and tattooing.'},
  {id:'desert_balm',name:'Desert Balm',icon:'🩹',ingr:['sunpetal','brine_moss','crystal_salt'],dc:11,xp:60,stat:'inu',unlock:2,cat:'healing',desc:'Soothes cracked skin and sun damage. Popular with travelers.'},
  {id:'sandstorm_flask',name:'Sandstorm Flask',icon:'🌪️',ingr:['wind_dust','dustite','ashbloom'],dc:10,xp:50,stat:'cre',unlock:1,cat:'damage',desc:'Release the cork and a localized sandstorm erupts. Useful distraction.'},
  {id:'cave_salt_elixir',name:'Cave Salt Elixir',icon:'💎',ingr:['crystal_salt','echo_fungus','mineral_clay'],dc:12,xp:65,stat:'acu',unlock:2,cat:'buff',desc:'Resonant salts amplify magical sensitivity.'},
  {id:'obsidian_varnish',name:'Obsidian Varnish',icon:'✨',ingr:['obsidian_shard','ashite'],dc:12,xp:65,stat:'tec',unlock:3,cat:'material',desc:'Protective coating that makes surfaces virtually indestructible.'},
  {id:'thornwine',name:'Thornwine',icon:'🍷',ingr:['thornvine','sunpetal','scorchroot'],dc:11,xp:55,stat:'cre',unlock:2,cat:'buff',desc:'Fermented desert brew. Burns going down, heals from within.'},
  {id:'silk_bandage_kit',name:'Silk Bandage Kit',icon:'🧵',ingr:['sandsilk','brine_moss'],dc:13,xp:70,stat:'tec',unlock:3,cat:'healing',desc:'Sandsilk bandages that promote rapid healing.'},
  {id:'venom_oil',name:'Venom Oil',icon:'☠️',ingr:['venomgland','scorchroot'],dc:14,xp:80,stat:'tec',unlock:4,cat:'material',desc:'Concentrated weapon poison. Handle with extreme caution.'},
  {id:'mirage_bomb',name:'Mirage Bomb',icon:'💥',ingr:['mirage_dust','wind_dust','dustite'],dc:14,xp:80,stat:'cre',unlock:6,cat:'damage',desc:'Creates a blinding flash of illusory images on detonation.'},
  {id:'oasis_draught',name:'Oasis Draught',icon:'🌴',ingr:['dewdrop_lily','palm_resin'],dc:13,xp:75,stat:'inu',unlock:4,cat:'healing',desc:'Restores vitality as if spending a day at the oasis.'},
  {id:'crystal_resonance',name:'Crystal Resonance Tonic',icon:'🔔',ingr:['crystal_salt','sand_merchant_seal','echo_fungus'],dc:16,xp:100,stat:'acu',unlock:5,cat:'buff',desc:'Attunes the drinker to magical frequencies.'},
  {id:'volcanic_salve',name:'Volcanic Salve',icon:'🌋',ingr:['volcanic_essence','obsidian_shard','scorchroot'],dc:15,xp:90,stat:'tec',unlock:5,cat:'healing',desc:'Burns like fire but heals like nothing else.'},
  {id:'dream_draught',name:'Dream Draught',icon:'💭',ingr:['dream_pollen','dewdrop_lily','mirage_dust'],dc:17,xp:120,stat:'inu',unlock:6,cat:'utility',desc:'Induces prophetic visions. Not for the faint of heart.'},
  {id:'temple_incense',name:'Temple Incense',icon:'🧯',ingr:['dream_pollen','flamekeeper_ember'],dc:16,xp:110,stat:'inu',unlock:6,faction:'flamekeepers',fReq:2,cat:'utility',desc:'Sacred incense that purifies spaces and calms the mind.'},
  {id:'sandworm_antitoxin',name:'Sandworm Antitoxin',icon:'🧪',ingr:['venomgland','sandsilk','crystal_salt'],dc:15,xp:95,stat:'acu',unlock:5,cat:'healing',desc:'Broad-spectrum antitoxin effective against all desert venoms.'},
  {id:'dust_diamond',name:'Dust Diamond Elixir',icon:'💎',ingr:['sand_merchant_seal','dustite','temple_gold'],dc:19,xp:160,stat:'acu',unlock:7,cat:'buff',desc:'Crystallized time. Said to slow aging.'},
  {id:'forge_ember_tonic',name:'Forge Ember Tonic',icon:'🔥',ingr:['volcanic_essence','embervein','molten_pearl'],dc:18,xp:140,stat:'tec',unlock:7,cat:'buff',desc:'Liquid fire that tempers the body like steel.'},

  // ═══ ASHFALL CARTOGRAPHER HIDDEN INGREDIENT RECIPES ═══
  {id:'oasis_bloom_tonic',name:'Oasis Bloom Tonic',icon:'🌵',ingr:['desert_bloom','sunpetal','crystal_salt'],xp:80,unlock:5,dc:14,stat:'inu',cat:'buff',
    desc:'Distilled from the Buried Oasis bloom. Boosts commerce and customer relations for 3 days.',buff:'oasis_bloom_tonic'},
  {id:'singing_salt_brew',name:'Singing Salt Brew',icon:'🎵',ingr:['singing_salt','crystal_salt','brine_moss'],xp:85,unlock:5,dc:14,stat:'acu',cat:'buff',
    desc:'Harmonic salt crystals dissolved into a resonant tonic. Sharpens enchanting for 3 days.',buff:'singing_salt_brew'},
  {id:'glass_bloom_elixir',name:'Glass Bloom Elixir',icon:'🖤',ingr:['hr_glass_bloom','obsidian_shard','scorchroot'],xp:90,unlock:6,dc:15,stat:'tec',cat:'buff',
    desc:'Volcanic glass essence — grants incredible precision for 3 days.',buff:'glass_bloom_elixir'},
  {id:'queen_silk_draught',name:'Queen Silk Draught',icon:'👑',ingr:['hr_queen_silk','venomgland','sandsilk'],xp:95,unlock:6,dc:16,stat:'tec',cat:'buff',
    desc:'Woven sandworm silk dissolved into liquid armor. Reduces ingredient loss for 3 days.',buff:'queen_silk_draught'},
  {id:'moonwell_philter',name:'Moonwell Philter',icon:'🌙',ingr:['moonwell_water','dewdrop_lily','moonpetal'],xp:95,unlock:6,dc:16,stat:'inu',cat:'buff',
    desc:'Water from the hidden moonwell. Massively boosts research and discovery for 4 days.',buff:'moonwell_philter'},
  {id:'dragon_fire_flask',name:'Dragon Fire Flask',icon:'🐉',ingr:['dragon_ash','living_ember','volcanic_essence'],xp:110,unlock:7,dc:18,stat:'tec',cat:'buff',
    desc:'Primordial fire from a dragon nesting site. The ultimate crafting accelerant for 2 days.',buff:'dragon_fire_flask'},
  {id:'spirit_draught',name:'Spirit Draught',icon:'👻',ingr:['spirit_essence','mirage_dust','sandsilk'],xp:100,unlock:7,dc:17,stat:'inu',cat:'buff',
    desc:'Concentrated mirage essence. Grants spectral perception — boosts all skills for 3 days.',buff:'spirit_draught'},
  {id:'vault_elixir',name:'Vault Gold Elixir',icon:'🏆',ingr:['vault_gold','ancient_resin','sand_merchant_seal'],xp:160,unlock:8,dc:20,stat:'acu',cat:'buff',
  ...
  {id:'tide_salt_tonic',name:'Tide Salt Tonic',icon:'🌊',ingr:['singing_salt_tc','tide_pearl','tidal_herb'],xp:80,unlock:5,dc:14,stat:'inu',cat:'buff',
  ...
  {id:'anemone_draught',name:'Anemone Draught',icon:'🪸',ingr:['giant_anemone_gel','prismatic_coral','sponge_extract'],xp:85,unlock:5,dc:14,stat:'acu',cat:'buff',
    desc:'Giant anemone gel combined with prismatic coral. Accelerates healing and learning for 3 days.',buff:'anemone_draught'},
  {id:'ambergris_philter',name:'Ambergris Philter',icon:'🐋',ingr:['ambergris','whale_bone_dust','echo_shell'],xp:90,unlock:6,dc:15,stat:'tec',cat:'buff',
    desc:'Whale-derived essence — strengthens foraging and extraction for 3 days.',buff:'ambergris_philter'},
  {id:'phosphor_elixir',name:'Phosphor Elixir',icon:'💡',ingr:['liquid_phosphor','glowworm_silk','cave_coral'],xp:90,unlock:6,dc:15,stat:'cre',cat:'buff',
    desc:'Bottled bioluminescence. Massively boosts enchanting precision for 3 days.',buff:'phosphor_elixir'},
  {id:'pearl_throne_tonic',name:'Pearl Throne Tonic',icon:'👑',ingr:['throne_pearl','royal_coral','reef_crystal'],xp:95,unlock:6,dc:16,stat:'inu',cat:'buff',
    desc:'Essence of the coral throne. Boosts sell prices and customer relations for 4 days.',buff:'pearl_throne_tonic'},
  {id:'pirate_gold_flask',name:'Pirate Gold Flask',icon:'🏴',ingr:['pirate_gold','enchanted_compass','cursed_doubloon'],xp:100,unlock:7,dc:17,stat:'inu',cat:'buff',
    desc:'Cursed gold dissolved in compass oil. Grants uncanny treasure sense for 3 days.',buff:'pirate_gold_flask'},
  {id:'vent_bloom_essence',name:'Vent Bloom Essence',icon:'🌋',ingr:['vent_bloom','tube_worm_extract','volcanic_vent_mineral'],xp:110,unlock:7,dc:18,stat:'tec',cat:'buff',
    desc:'Deep-sea vent life distilled. The ultimate crafting accelerant for 2 days.',buff:'vent_bloom_essence'},
  {id:'oracle_elixir',name:'Oracle\'s Elixir',icon:'🔮',ingr:['oracle_tear','abyssal_rune_stone','trench_pearl'],xp:160,unlock:8,dc:20,stat:'inu',cat:'buff',
  ...
  {id:'ice_ward_potion',name:'Ice Ward Potion',icon:'🧊',ingr:['ice_crystal','hearthstone'],xp:65,unlock:4,dc:14,stat:'tec',cat:'buff',
    desc:'Liquid warmth that protects against the deepest cold. Sells at a premium in winter.'},
  {id:'winter_fortifier',name:'Winter Fortifier',icon:'🫖',ingr:['frostbloom','ice_crystal','ironroot_bark'],xp:80,unlock:5,dc:15,stat:'dis',cat:'buff',
    desc:'A thick warming brew that sustains body and spirit through the harshest season.'},
  {id:'autumn_preserve',name:'Autumn Preserve',icon:'🍂',ingr:['amber_leaf','harvest_root'],xp:50,unlock:2,dc:11,stat:'tec',cat:'utility',
    desc:'Concentrated harvest essence. Extends ingredient storage and sells well to travelers stocking up.'},
  {id:'harvest_elixir',name:'Harvest Elixir',icon:'🥕',ingr:['harvest_root','amber_leaf','ashbloom'],xp:65,unlock:4,dc:13,stat:'inu',cat:'buff',
    desc:'A golden elixir that embodies autumn abundance. Grants the drinker renewed vigor.'},
  {id:'spring_tonic',name:'Spring Tonic',icon:'💧',ingr:['spring_dewdrop','ashbloom'],xp:45,unlock:1,dc:10,stat:'inu',cat:'healing',
    desc:'Fresh morning dew distilled into a revitalizing tonic. A seasonal favorite.'},
  {id:'renewal_draught',name:'Renewal Draught',icon:'🌱',ingr:['spring_dewdrop','moonpetal','embercap'],xp:70,unlock:4,dc:14,stat:'cre',cat:'healing',
    desc:'Captures the essence of spring regrowth. Potent healing properties.'},
  // ── Seasonal Recipes (Ashfall) ──
  {id:'bloom_nectar',name:'Bloom Nectar',icon:'🌺',ingr:['desert_rain_lily','sunpetal'],xp:55,unlock:3,dc:12,stat:'inu',cat:'buff',
    desc:'Nectar from the rare desert bloom. Extraordinarily fragrant and alchemically potent.'},
  {id:'monsoon_elixir',name:'Monsoon Elixir',icon:'🌧️',ingr:['desert_rain_lily','wet_sand_crystal'],xp:75,unlock:5,dc:15,stat:'cre',cat:'buff',
    desc:'Captures the power of the desert rains. Drinkers feel the rush of a flash flood coursing through their veins.'},
  {id:'sand_crystal_salve',name:'Sand Crystal Salve',icon:'💎',ingr:['wet_sand_crystal','crystal_salt'],xp:60,unlock:3,dc:13,stat:'tec',cat:'buff',
    desc:'Ground sand crystals form a protective salve against desert heat and abrasion.'},
  {id:'dust_shield_potion',name:'Sandstorm Ward',icon:'💨',ingr:['dust_amber','scorchroot'],xp:50,unlock:2,dc:11,stat:'dis',cat:'buff',
    desc:'Coating the skin with this potion repels dust and sand. Essential during dust season.'},
  {id:'sandstorm_brew',name:'Sandstorm Brew',icon:'🌪️',ingr:['dust_amber','obsidian_shard','dustite'],xp:70,unlock:4,dc:14,stat:'tec',cat:'buff',
    desc:'Infused with the fury of the sandstorms. Grants resistance to wind and abrasion.'},
  // ── Seasonal Recipes (Skyreach) ──
  {id:'thaw_tonic',name:'Thaw Tonic',icon:'🌷',ingr:['thaw_blossom','cloud_moss'],xp:55,unlock:3,dc:12,stat:'inu',cat:'buff',
    desc:'Glacial blossom distilled into a warming tonic. Only brewable during the thaw when fresh blossoms emerge.'},
  {id:'icefall_elixir',name:'Icefall Elixir',icon:'❆',ingr:['icefall_crystal','frost_daisy','windstone'],xp:75,unlock:5,dc:15,stat:'tec',cat:'buff',
    desc:'Shattered glacier crystal in solution. Grants extraordinary focus and cold resistance.',buff:'icefall_elixir'},
  {id:'storm_petal_brew',name:'Storm Petal Brew',icon:'🌩️',ingr:['storm_bloom','storm_petal'],xp:60,unlock:3,dc:13,stat:'cre',cat:'buff',
    desc:'Electrically charged petals brewed during lightning storms. Crackles with raw energy.'},
  // ═══ ASHFALL EXPANSION RECIPES ═══
  {id:'cactus_poultice',name:'Cactus Poultice',icon:'🌵',ingr:['dried_cactus','salt_flake'],xp:20,unlock:0,dc:7,stat:'inu',cat:'healing',
    desc:'A basic desert remedy. Dried cactus flesh draws out heat while salt flakes seal the wound.'},
  {id:'sandglass_lens',name:'Sandglass Lens Tonic',icon:'🪟',ingr:['sand_glass','sandstone_dust'],xp:35,unlock:1,dc:9,stat:'tec',cat:'utility',
    desc:'Ground sand glass suspended in palm resin. Sharpens vision in blinding desert light.'},
  {id:'chitin_paste',name:'Chitin Paste',icon:'🐜',ingr:['fire_ant_chitin','red_clay'],xp:40,unlock:1,dc:10,stat:'tec',cat:'buff',
    desc:'Fire ant armor dissolved in red clay. Hardens into a protective coating on skin or equipment.'},
  {id:'scarab_tonic',name:'Scarab Tonic',icon:'🪲',ingr:['scarab_shell','sandstone_dust'],xp:50,unlock:2,dc:11,stat:'dis',cat:'healing',
    desc:'Pulverized scarab shell in sandstone suspension. Desert healers swear by its restorative properties.'},
  {id:'sulfur_flash',name:'Sulfur Flash Bomb',icon:'💛',ingr:['sulfur_crystal','heatstone'],xp:55,unlock:2,dc:12,stat:'tec',cat:'damage',
    desc:'Volatile sulfur crystals packed with heatstone. Detonates in a blinding flash and choking cloud.'},
  {id:'ghost_pepper_oil',name:'Ghost Pepper Oil',icon:'🌶️',ingr:['ghost_pepper','desert_rose'],xp:65,unlock:3,dc:13,stat:'cre',cat:'damage',
    desc:'Unbearably hot oil from ghost peppers tempered with desert rose essence. Weaponized heat in a flask.'},
  {id:'venom_silk_wrap',name:'Venom Silk Bandage',icon:'🕷️',ingr:['venom_silk','worm_tooth'],xp:70,unlock:3,dc:13,stat:'inu',cat:'healing',
    desc:'Bandages woven from venom silk and treated with ground worm tooth. Numbs pain and accelerates healing.'},
  {id:'desert_iron_tonic',name:'Desert Iron Tonic',icon:'⛏️',ingr:['desert_iron','sulfur_crystal','scorchroot'],xp:80,unlock:4,dc:14,stat:'dis',cat:'buff',
    desc:'Liquid iron fortified with sulfur. Strengthens bones and hardens resolve against the desert.'},
  {id:'spirit_sand_elixir',name:'Spirit Sand Elixir',icon:'👻',ingr:['spirit_sand','glass_bloom'],xp:90,unlock:5,dc:15,stat:'inu',cat:'utility',
    desc:'Sand from sacred grounds mixed with glass bloom petals. The drinker perceives hidden truths.'},
  {id:'storm_glass_flask',name:'Storm Glass Flask',icon:'⚡',ingr:['storm_glass','lava_glass'],xp:95,unlock:5,dc:16,stat:'tec',cat:'damage',
    desc:'Two types of volcanic glass fused with opposing charges. Releases controlled lightning on impact.'},
  {id:'sun_diamond_draught',name:'Sun Diamond Draught',icon:'💎',ingr:['sun_diamond','fire_opal','gold_dust'],xp:110,unlock:6,dc:17,stat:'cre',cat:'buff',
    desc:'Liquid sunlight concentrated through diamond and opal. Radiates warmth and courage for days.'},
  {id:'molten_pearl_elixir',name:'Molten Pearl Elixir',icon:'🫧',ingr:['molten_pearl','fire_opal'],xp:105,unlock:6,dc:17,stat:'inu',cat:'buff',
    desc:'A pearl from the caldera dissolved in temple jade essence. Grants fire immunity for a day.'},
  {id:'relic_restoration',name:'Relic Restoration Fluid',icon:'🏺',ingr:['buried_relic','oasis_pearl','temple_jade'],xp:130,unlock:7,dc:18,stat:'acu',cat:'utility',
    desc:'An archaeologist\'s dream — liquid that reverses millennia of decay. Nahla\'s personal formula.'},
  {id:'desert_star_elixir',name:'Desert Star Elixir',icon:'⭐',ingr:['desert_star','sun_crown_shard','dustwalker_compass','pharaoh_dust'],xp:170,unlock:8,dc:20,stat:'cre',cat:'buff',
  ...
  {id:'brine_tonic',name:'Brine Tonic',icon:'🧂',ingr:['sea_salt','kelp_frond'],xp:25,unlock:0,dc:7,stat:'inu',cat:'healing',
    desc:'Simple saltwater remedy. Treats dehydration and minor infections.'},
  {id:'kelp_wrap',name:'Kelp Wrap',icon:'🩹',ingr:['kelp_frond','tide_moss'],xp:30,unlock:0,dc:8,stat:'inu',cat:'healing',
    desc:'A poultice of living kelp that draws out toxins and speeds healing.'},
  {id:'foam_salve',name:'Foam Salve',icon:'🫧',ingr:['foam_bloom','dried_seaweed'],xp:28,unlock:0,dc:8,stat:'tec',cat:'healing',
    desc:'Whipped sea foam stabilized with seaweed. Soothes burns and abrasions.'},
  {id:'barnacle_paste',name:'Barnacle Paste',icon:'🔩',ingr:['barnacle','driftwood'],xp:22,unlock:0,dc:7,stat:'tec',cat:'material',
    desc:'Tough adhesive compound. The harbor\'s favorite quick-fix for everything from hulls to bones.'},
  {id:'urchin_oil',name:'Urchin Oil',icon:'🦔',ingr:['urchin_spine','salt_crystal'],xp:40,unlock:1,dc:10,stat:'tec',cat:'material',
    desc:'Slippery, sharp-smelling oil extracted from sea urchin spines. Cuts through rust and corrosion.'},
  {id:'coral_potion',name:'Coral Mend Potion',icon:'🪸',ingr:['coral_shard','anemone_extract'],xp:45,unlock:1,dc:10,stat:'inu',cat:'healing',
    desc:'Living coral extract that bonds with bone and shell. Used by divers for pressure injuries.'},
  {id:'sailors_grog',name:'Sailor\'s Grog',icon:'🍺',ingr:['sea_glass','sponge_pulp','kelp_frond'],xp:38,unlock:1,dc:9,stat:'inu',cat:'healing',
    desc:'Not technically medicinal. But sailors swear it cures everything from scurvy to heartbreak.'},
  {id:'jellyfish_balm',name:'Jellyfish Balm',icon:'🪼',ingr:['jellyfish_essence','pearl_dust'],xp:55,unlock:2,dc:12,stat:'inu',cat:'healing',
    desc:'Neutralizes venom and numbs pain. Essential for reef divers.'},
  {id:'stormkelp_brew',name:'Stormkelp Brew',icon:'⛈️',ingr:['stormkelp','phosphor_moss'],xp:60,unlock:2,dc:12,stat:'tec',cat:'buff',
    desc:'Charged with bioelectric energy. One sip and your reflexes sharpen to lightning speed.'},
  {id:'pearl_elixir',name:'Pearl Clarity Elixir',icon:'💧',ingr:['pearl_dust','anglerfish_lure','sea_amber'],xp:65,unlock:3,dc:13,stat:'acu',cat:'buff',
    desc:'Distilled pearl dust grants supernatural clarity of thought. Scholars pay a fortune for this.'},
  {id:'fog_draught',name:'Fog Draught',icon:'🌫️',ingr:['fog_essence','cave_pearl'],xp:60,unlock:3,dc:13,stat:'inu',cat:'utility',
    desc:'Bottled sea fog that, when drunk, makes the imbiber nearly invisible in mist or rain.'},
  {id:'cave_coral_paste',name:'Cave Coral Paste',icon:'🪸',ingr:['echo_coral','drip_mineral','bat_guano'],xp:55,unlock:3,dc:12,stat:'tec',cat:'material',
    desc:'A luminescent paste that hardens into an unbreakable seal. Perfect for underwater repairs.'},
  {id:'depth_ward',name:'Depth Ward Potion',icon:'🛡️',ingr:['nautilus_shell','whale_oil'],xp:70,unlock:4,dc:14,stat:'tec',cat:'buff',
    desc:'Protects the body against crushing deep-sea pressure. Mandatory for trench dives.'},
  {id:'siren_draught',name:'Siren Draught',icon:'🧜',ingr:['siren_tear','deep_coral'],xp:80,unlock:4,dc:15,stat:'inu',cat:'buff',
    desc:'A single tear from the deep distilled into liquid charisma. The drinker\'s voice becomes irresistible.'},
  {id:'reef_tonic',name:'Reef Tonic',icon:'🐠',ingr:['giant_clam','sea_fan','moonfish_scale'],xp:75,unlock:4,dc:14,stat:'inu',cat:'healing',
    desc:'A vibrant cocktail of reef essences that accelerates natural healing and boosts vitality.'},
  {id:'ghost_lantern_oil',name:'Ghost Lantern Oil',icon:'🏮',ingr:['ghost_lantern','ships_tar','rust_iron'],xp:90,unlock:5,dc:16,stat:'tec',cat:'utility',
    desc:'Burns with an eerie green flame that illuminates the invisible — spirits, illusions, hidden traps.'},
  {id:'kraken_ink_potion',name:'Kraken Ink Brew',icon:'🦑',ingr:['kraken_ink','stormkelp'],xp:100,unlock:6,dc:17,stat:'acu',cat:'utility',
    desc:'Ink from the deep given alchemical life. Grants the drinker the ability to breathe underwater for a full day.'},
  {id:'leviathan_draught',name:'Leviathan Draught',icon:'🐋',ingr:['leviathan_scale','abyssal_pearl'],xp:110,unlock:6,dc:17,stat:'dis',cat:'buff',
    desc:'The essence of the deep\'s greatest predator. Grants inhuman endurance and resistance to cold.'},
  {id:'pressure_flask',name:'Pressure Flask',icon:'💎',ingr:['pressure_crystal','compass_needle','cannon_bronze'],xp:105,unlock:6,dc:17,stat:'tec',cat:'material',
    desc:'A flask that can withstand the crushing pressures of the abyssal trench. Used to store volatile deep-sea reagents.'},
  {id:'tidal_surge',name:'Tidal Surge Potion',icon:'🌊',ingr:['tidal_diamond','trident_shard'],xp:120,unlock:7,dc:18,stat:'dis',cat:'buff',
    desc:'Channels the raw power of the tides through the drinker\'s body. Briefly grants superhuman strength.'},
  {id:'primordial_brine_elixir',name:'Primordial Brine',icon:'🌀',ingr:['primordial_brine','drowned_god_relic','tidekeeper_sigil'],xp:150,unlock:8,dc:19,stat:'inu',cat:'utility',
    desc:'Liquid from before the world had shores. Drinking it is said to let you hear the voice of the first ocean.'},
  {id:'abyssal_diamond_flask',name:'Abyssal Diamond Flask',icon:'💠',ingr:['abyssal_diamond','leviathan_heart','sea_crown_jewel'],xp:170,unlock:8,dc:20,stat:'acu',cat:'buff',
    desc:'The sea\'s deepest treasures fused into a single transcendent draught. The pinnacle of maritime alchemy.'},
  {id:'sand_dollar_salve',name:'Sand Dollar Salve',icon:'🪙',ingr:['sand_dollar','crab_shell'],xp:30,unlock:0,dc:8,stat:'inu',cat:'healing',
    desc:'Crushed sand dollar mixed with crab shell powder. A simple beach remedy for cuts and stings.'},
  {id:'tidepool_broth',name:'Tidepool Broth',icon:'🫕',ingr:['sea_snail','starfish_arm'],xp:35,unlock:1,dc:9,stat:'inu',cat:'healing',
    desc:'Simmered from tidepool creatures. Surprisingly nourishing and mildly curative.'},
  {id:'cave_biolume',name:'Cave Biolume Paste',icon:'💡',ingr:['cave_lichen_tc','blind_shrimp'],xp:50,unlock:3,dc:12,stat:'tec',cat:'utility',
    desc:'Bioluminescent paste from cave-dwelling organisms. Glows for hours underwater.'},
  {id:'reef_stone_tonic',name:'Reef Stone Tonic',icon:'🪨',ingr:['driftstone','brine_crystal'],xp:55,unlock:3,dc:12,stat:'tec',cat:'buff',
    desc:'Minerals dissolved in concentrated brine. Strengthens bones and hardens skin.'},
  {id:'barnacle_armor_oil',name:'Barnacle Armor Oil',icon:'🛡️',ingr:['barnacle_cluster','waterlogged_timber'],xp:70,unlock:5,dc:14,stat:'tec',cat:'material',
    desc:'Oil extracted from deep-growth barnacle colonies. Coats any surface in a near-impenetrable shell.'},
  {id:'shark_fang_elixir',name:'Shark Fang Elixir',icon:'🦈',ingr:['sharktooth','deep_brine'],xp:80,unlock:5,dc:15,stat:'dis',cat:'buff',
    desc:'Ground sharktooth in pressurized brine. Grants predatory focus and fearlessness.'},
  {id:'vent_mineral_flask',name:'Vent Mineral Flask',icon:'🌋',ingr:['abyssal_vent_mineral','storm_glass_tc'],xp:110,unlock:7,dc:18,stat:'tec',cat:'damage',
    desc:'Volcanic minerals from ocean floor vents, stabilized in storm glass. Explosive potential.'},
  {id:'harbor_alliance_brew',name:'Harbor Alliance Brew',icon:'🤝',ingr:['harbor_seal','trade_manifest','diver_token'],xp:140,unlock:8,dc:19,stat:'inu',cat:'other',
    desc:'A ceremonial brew binding all harbor factions in alliance. Only brewed in times of great need.'},

  // ═══ SKYREACH RECIPES ═══
  // Intro (DC 7-8)
  {id:'altitude_tonic',name:'Altitude Tonic',icon:'🫁',ingr:['cloud_moss','windstone'],xp:25,unlock:0,dc:7,stat:'inu',cat:'healing',
    desc:'A simple tonic that eases altitude sickness and steadies the breath. Every Skyreach alchemist\'s first recipe.'},
  {id:'frost_poultice',name:'Frost Poultice',icon:'🩹',ingr:['frost_daisy','summit_grass'],xp:22,unlock:0,dc:7,stat:'inu',cat:'healing',
    desc:'Frost daisy crushed with summit grass. A rough field dressing that numbs pain on contact.'},
  {id:'breeze_balm',name:'Breeze Balm',icon:'🧴',ingr:['breeze_seed','sky_clover'],xp:28,unlock:0,dc:8,stat:'tec',cat:'healing',
    desc:'Windborne seeds ground into a cooling salve. Applied to sore muscles after a day\'s climb.'},
  {id:'cloud_berry_tonic',name:'Cloud Berry Tonic',icon:'🫐',ingr:['cloud_berry','eagle_down'],xp:30,unlock:0,dc:8,stat:'inu',cat:'healing',
    desc:'Tart cloud berry juice softened with eagle down fiber. Visitors from below can\'t get enough.'},
  {id:'mountain_tea',name:'Mountain Tea',icon:'☕',ingr:['alpine_mint','cloud_moss'],xp:20,unlock:0,dc:7,stat:'inu',cat:'healing',
    desc:'Hot mint tea brewed from alpine herbs. The whole settlement drinks it. Surprisingly lucrative.'},
  {id:'summit_paste',name:'Summit Paste',icon:'🏔️',ingr:['thin_air_lichen','frost_daisy'],xp:30,unlock:0,dc:8,stat:'tec',cat:'buff',
    desc:'Lichen scraped from exposed peaks mixed into a thick paste. Hardens skin against wind and cold.'},
  // Early (DC 9-10)
  {id:'fog_tincture',name:'Fog Tincture',icon:'🌫️',ingr:['drip_fungus','hanging_lichen'],xp:35,unlock:1,dc:9,stat:'inu',cat:'healing',
    desc:'Distilled cloud forest moisture. Clears the lungs and sharpens sight in poor visibility.'},
  {id:'mistwood_tonic',name:'Mistwood Tonic',icon:'🌲',ingr:['mistwood_bark','cloud_berry'],xp:38,unlock:1,dc:9,stat:'tec',cat:'buff',
    desc:'Aromatic bark steeped with cloud berry. Strengthens the body against altitude fatigue.'},
  {id:'gale_powder',name:'Gale Powder',icon:'💨',ingr:['gale_salt','storm_petal'],xp:42,unlock:1,dc:10,stat:'cre',cat:'damage',
    desc:'Volatile powder that erupts into a blinding wind gust when thrown. Scouts swear by it.'},
  {id:'cliff_salve',name:'Cliff Salve',icon:'🪨',ingr:['cliff_quartz','ice_moss'],xp:40,unlock:1,dc:10,stat:'tec',cat:'healing',
    desc:'Powdered cliff quartz suspended in ice moss gel. Treats fractures and deep bruises from falls.'},
  {id:'raptor_eye_brew',name:'Raptor Eye Brew',icon:'🦅',ingr:['raptor_plume','fog_orchid'],xp:45,unlock:1,dc:10,stat:'acu',cat:'utility',
    desc:'Raptor plume infused with fog orchid nectar. Grants preternaturally sharp vision for hours.'},
  {id:'cloud_wine',name:'Cloud Wine',icon:'🍷',ingr:['cloud_berry','alpine_mint','drip_fungus'],xp:35,unlock:1,dc:9,stat:'inu',cat:'other',
    desc:'Skyreach\'s famous local vintage. Fermented cloud berry with mint and fungal cultures.'},
  // Mid (DC 11-12)
  {id:'canopy_elixir',name:'Canopy Elixir',icon:'🌿',ingr:['canopy_dew','vapor_fern'],xp:50,unlock:2,dc:11,stat:'inu',cat:'healing',
    desc:'Concentrated cloud forest dew. A powerful healing draught.'},
  {id:'mist_silk_wrap',name:'Mist Silk Bandage',icon:'🕸️',ingr:['mist_silk','fog_orchid'],xp:48,unlock:2,dc:11,stat:'inu',cat:'healing',
    desc:'Living spider silk soaked in fog orchid extract. The bandage bonds with flesh.'},
  {id:'wind_iron_oil',name:'Wind Iron Oil',icon:'⚒️',ingr:['wind_iron','rime_dust'],xp:55,unlock:2,dc:12,stat:'tec',cat:'material',
    desc:'Wind-hardened iron dissolved in rime powder. Makes blades cut through armor.'},
  {id:'echo_draught',name:'Echo Draught',icon:'🔔',ingr:['echo_mineral','crystal_moss_sr'],xp:55,unlock:3,dc:12,stat:'acu',cat:'utility',
    desc:'A resonant liquid that amplifies perception. You hear heartbeats through stone walls.'},
  {id:'rime_bomb',name:'Rime Bomb',icon:'💣',ingr:['rime_dust','cave_frost_sr'],xp:50,unlock:2,dc:11,stat:'cre',cat:'damage',
    desc:'A brittle sphere that shatters into a flash-freeze blast. Everything in range is coated in ice.'},
  {id:'skystone_draught',name:'Skystone Draught',icon:'🏗️',ingr:['skystone_chip','pressure_quartz'],xp:58,unlock:3,dc:12,stat:'dis',cat:'buff',
    desc:'Pulverized Skyreach stone in quartz suspension. The drinker becomes unyielding as the mountain.'},
  {id:'thin_air_elixir',name:'Thin Air Elixir',icon:'💨',ingr:['thin_air_lichen','alpine_mint','windstone'],xp:52,unlock:2,dc:11,stat:'dis',cat:'buff',
    desc:'Teaches the lungs to drink thin air. Endurance at altitude doubles for a full day.'},
  // Advanced (DC 13-14)
  {id:'altitude_lens',name:'Crystal Lens Brew',icon:'🔎',ingr:['altitude_crystal','echo_mineral'],xp:65,unlock:3,dc:13,stat:'acu',cat:'utility',
    desc:'Altitude crystals ground to clarity. The drinker perceives the structure of magic itself.'},
  {id:'glacier_salve',name:'Glacier Salve',icon:'🧊',ingr:['glacial_silt','frozen_bloom'],xp:60,unlock:4,dc:13,stat:'inu',cat:'healing',
    desc:'Millennial glacial sediment with a flower preserved in ice. Heals wounds that refuse to close.'},
  {id:'meltwater_draught',name:'Meltwater Draught',icon:'💧',ingr:['meltwater_pearl','ice_moss','glacial_silt'],xp:68,unlock:4,dc:14,stat:'inu',cat:'healing',
    desc:'Glacial pearl dissolved in meltwater. The purest healing draught in Skyreach.'},
  {id:'aurora_lamp',name:'Aurora Lamp Oil',icon:'🌈',ingr:['aurora_lichen','lake_crystal'],xp:70,unlock:4,dc:14,stat:'acu',cat:'utility',
    desc:'Aurora lichen extract suspended in lake crystal. Burns with colors that reveal enchantment auras.'},
  {id:'coldsnap_bomb',name:'Coldsnap Bomb',icon:'❄️',ingr:['coldsnap_root','cave_frost_sr','rime_dust'],xp:65,unlock:4,dc:14,stat:'cre',cat:'damage',
    desc:'Triple-cold reagents compressed into an unstable mass. Detonates into a localized blizzard.'},
  {id:'summit_fortitude',name:'Summit Fortitude',icon:'🗿',ingr:['summit_coral','frozen_bloom'],xp:62,unlock:3,dc:13,stat:'dis',cat:'buff',
    desc:'Ancient coral from when the peaks were sea floor. The drinker gains the patience of stone.'},
  {id:'frost_amber_polish',name:'Frost Amber Polish',icon:'🟡',ingr:['frost_amber','wind_iron'],xp:68,unlock:4,dc:14,stat:'tec',cat:'material',
    desc:'Frozen tree resin alloyed with wind iron. Weapons treated with this never dull or corrode.'},
  // High (DC 15-16)
  {id:'stormglass_oil',name:'Stormglass Blade Oil',icon:'⚡',ingr:['stormglass','lightning_shard'],xp:80,unlock:5,dc:15,stat:'tec',cat:'material',
    desc:'Natural glass fused by lightning, ground and suspended in oil. Each blow crackles with discharge.'},
  {id:'lightning_flask',name:'Lightning Flask',icon:'🧨',ingr:['lightning_shard','charged_quartz','gale_salt'],xp:85,unlock:5,dc:16,stat:'cre',cat:'damage',
    desc:'Captured lightning compressed into a flask. Handle with extreme care.'},
  {id:'storm_pearl_elixir',name:'Storm Pearl Elixir',icon:'🔮',ingr:['storm_pearl_sr','tempest_moss'],xp:82,unlock:5,dc:15,stat:'acu',cat:'buff',
    desc:'A pearl forged by storms dissolved in living moss. Grants danger sense.'},
  {id:'thunder_draught',name:'Thunder Draught',icon:'🌩️',ingr:['thunder_iron','stormglass'],xp:78,unlock:5,dc:15,stat:'dis',cat:'buff',
    desc:'Iron charged by a thousand storms. The drinker becomes immune to fear.'},
  {id:'windrunner_speed',name:'Windrunner Draught',icon:'🏃',ingr:['charged_quartz','raptor_plume','mist_silk'],xp:88,unlock:6,dc:16,stat:'dis',cat:'buff',
    desc:'The Windrunners\' secret formula. The drinker moves with impossible speed.'},
  {id:'star_metal_flux',name:'Star Metal Flux',icon:'☄️',ingr:['star_metal','sky_rune_fragment'],xp:90,unlock:6,dc:16,stat:'tec',cat:'material',
  ...
  {id:'skyward_ward',name:'Skywarden\'s Ward',icon:'🛡️',ingr:['skyward_seal','windstone','altitude_crystal'],xp:100,unlock:6,dc:15,stat:'dis',faction:'skywardens',fReq:2,cat:'utility',
    desc:'Official Skywarden protection ward. Planted along mountain passes to repel threats.'},
  {id:'celestial_ink',name:'Celestial Ink',icon:'✒️',ingr:['starcaller_seal','aurora_lichen','meltwater_pearl'],xp:100,unlock:6,dc:15,stat:'acu',faction:'starcallers',fReq:3,cat:'material',
    desc:'Ink that shimmers with starlight. Enchantments inscribed with this are permanently more powerful.'},
  {id:'cloud_trader_blend',name:'Cloud Trader\'s Blend',icon:'📦',ingr:['cloud_trader_token','frost_amber','mist_silk'],xp:100,unlock:6,dc:15,stat:'inu',faction:'cloud_traders',fReq:2,cat:'utility',
    desc:'The Cloud Traders\' exclusive blend. One sip and any merchant treats you like family.'},
  {id:'void_edge_oil',name:'Void Edge Oil',icon:'🗡️',ingr:['levitation_dust','star_metal','thunder_iron'],xp:105,unlock:7,dc:17,stat:'tec',cat:'material',
    desc:'Gravity-defying dust mixed with alien iron. A treated blade cuts through magical barriers.'},
  {id:'bolt_crystal_bomb',name:'Bolt Crystal Bomb',icon:'💥',ingr:['bolt_crystal','lightning_shard','stormglass'],xp:110,unlock:7,dc:17,stat:'cre',cat:'damage',
    desc:'A captured lightning bolt crystallized around volatile storm reagents.'},
  {id:'stargazer_draught',name:'Stargazer\'s Draught',icon:'🔭',ingr:['celestial_mortar','eclipse_shard','aurora_lichen'],xp:108,unlock:7,dc:17,stat:'acu',cat:'utility',
    desc:'Sky civilization materials dissolved into shimmering tonic. See the stars in daylight.'},
  // Endgame (DC 19-20)
  {id:'primordial_gale',name:'Primordial Gale',icon:'🌪️',ingr:['primordial_wind','void_feather','ancient_windstone'],xp:150,unlock:8,dc:19,stat:'inu',cat:'buff',
    desc:'Wind from the world\'s birth. Drinking it is like swallowing a hurricane. You survive. Barely.'},
  {id:'zenith_elixir',name:'Zenith Elixir',icon:'⭐',ingr:['zenith_stone','celestial_essence','void_crystal'],xp:170,unlock:8,dc:20,stat:'acu',cat:'buff',
    desc:'The pinnacle of Skyreach alchemy. Three impossible ingredients fused into transcendence.'},
  {id:'skyreach_alliance',name:'Skyreach Alliance Brew',icon:'🤝',ingr:['skyward_seal','starcaller_seal','cloud_trader_token'],xp:140,unlock:8,dc:19,stat:'inu',cat:'other',
  ...
  {id:'spring_mineral_tonic',name:'Spring Mineral Tonic',icon:'♨️',ingr:['spring_mineral','cloud_moss','windstone'],xp:80,unlock:5,dc:14,stat:'inu',cat:'buff',
    desc:'Mineral water from the hidden hot spring. Warms the body and sharpens commerce for 3 days.',buff:'spring_mineral_tonic'},
  {id:'crown_pollen_brew',name:'Crown Pollen Brew',icon:'🌻',ingr:['crown_epiphyte','sky_pollen','canopy_dew'],xp:85,unlock:5,dc:14,stat:'acu',cat:'buff',
    desc:'Canopy-top pollen distilled into a mind-sharpening brew. +2 research, +1 craft for 3 days.',buff:'crown_pollen_brew'},
  {id:'vault_quartz_elixir',name:'Vault Quartz Elixir',icon:'🔶',ingr:['petrified_plume','vault_quartz','cliff_quartz'],xp:90,unlock:6,dc:15,stat:'tec',cat:'buff',
  ...
  {id:'harmonic_draught',name:'Harmonic Draught',icon:'🎵',ingr:['harmonic_shard','resonance_bloom','altitude_crystal'],xp:95,unlock:6,dc:16,stat:'acu',cat:'buff',
    desc:'Crystal harmonics tuned to perfection. +3 inscription, +8 enchant bonus for 3 days.',buff:'harmonic_draught'},
  {id:'frozen_garden_philter',name:'Frozen Garden Philter',icon:'🥀',ingr:['frozen_fern','ice_pearl','glacial_silt'],xp:95,unlock:6,dc:16,stat:'inu',cat:'buff',
    desc:'Plants preserved in ice for millennia, essence still vital. +25% discovery, +20% XP for 4 days.',buff:'frozen_garden_philter'},
  {id:'lightning_throne_flask',name:'Lightning Throne Flask',icon:'👑',ingr:['throne_crystal','fused_iron','lightning_shard'],xp:110,unlock:7,dc:18,stat:'tec',cat:'buff',
    desc:'Crystallized lightning from the Throne. +5 craft, +30% double batch for 2 days.',buff:'lightning_throne_flask'},
  {id:'starfall_draught',name:'Starfall Draught',icon:'🌠',ingr:['starfall_fragment','celestial_gear','star_metal'],xp:100,unlock:7,dc:17,stat:'acu',cat:'buff',
    desc:'Sky civilization machinery still hums with power. Grants broad enhancement for 3 days.',buff:'starfall_draught'},
  {id:'lens_elixir',name:'Focused Starlight Elixir',icon:'🔍',ingr:['lens_crystal','focused_starlight','celestial_essence'],xp:160,unlock:8,dc:20,stat:'acu',cat:'buff',
...
var ENCHANTMENTS=[
  ...
  {id:'e_sand_dollar_luck',name:'Sand Dollar Luck',icon:'🍀',cat:'other',ingr:['sand_dollar','crab_shell'],xp:40,dc:9,desc:'A lucky sand dollar charm. The wearer finds better ingredients and more coin.'},
...
var PLANAR_COMBOS={
  ...
  'feywild+astral_sea':{name:'Dreamweave',icon:'💫',desc:'Dreamy precision. All enchantments auto-succeed DC 12 or below. +20% coin from utility enchants.',effects:{autoSuccessDC:12,utilityGoldMult:1.2}},
  ...
  'elemental_chaos+astral_sea':{name:'Primordial Order',icon:'⚛️',desc:'Chaos contained by cosmic law. +3 inscription, +25% coin, no material destruction on failure.',effects:{inscriptionBonus:3,allGoldMult:1.25}},
};
...
var LORE_CHAINS={
  ...
  ashwarden:{id:'ashwarden',name:'Ashwarden Chronicles',icon:'⚔️',color:'#cc5544',
    ...
    reward:{questGoldBonus:0.20,questRepBonus:5},rewardDesc:'+20% quest coin and +5 rep permanently'},
  // ── Ashfall Crossing ──
...
var RANGER_COMPANIONS=[
  ...
  {id:'rc_hawk',name:'Ash Hawk',icon:'🦅',region:'ironwood',role:'scout',color:'#6090c0',
    ...
    legendary:'Once/day: instant travel (0 Energy) to any region',passive:{reducedRisk:0.15,energyCostMultiplier:{travel:-0.25}}},
  ...
  {id:'rc_salamander',name:'Fire Salamander',icon:'🦎',region:'volcanic_vents',role:'guardian',color:'#d04040',
    ...
    secondary:{type:'guard',desc:'Prevents negative morning events that cost coin',unlockLv:3},
  ...
  {id:'rc_vulture',name:'Obsidian Vulture',icon:'🦅',region:'obsidian_wastes',role:'scout',color:'#404040',
    ...
    primary:{type:'danger_reduce',values:[0.25,0.40,0.50,0.60,0.75]},
    secondary:{type:'travel_reduce',desc:'−25 Energy travel cost to scouted region',unlockLv:3},
    legendary:'Once/day: instant travel (0 Energy) to any Ashfall region',passive:{reducedRisk:0.15,energyCostMultiplier:{travel:-0.25}}},
  ...
  {id:'rc_seahawk',name:'Tidecrest Hawk',icon:'🦅',region:'driftwood_shores',role:'scout',color:'#6090b0',
    ...
    legendary:'Danger events auto-avoided at Soulbound loyalty',passive:{reducedRisk:0.15,energyCostMultiplier:{travel:-0.25}}},
  ...
  {id:'rc_seal',name:'Harbor Seal',icon:'🦭',region:'shipwreck_graveyard',role:'trade',color:'#7a7a5a',
    ...
    legendary:'Doubles coin from shelf sales at Soulbound loyalty',passive:{sellBonus:0.08,customerBonus:1}},
  ...
  {id:'rc_falcon',img:'https://jumppiejim-creator.github.io/cindervale-alchemist/companion_rc_falcon.jpg',name:'Cliff Falcon',icon:'🐦‍⬛',region:'windcarved_cliffs',role:'scout',color:'#6080a0',loc:'skyreach',
    ...
    primary:{type:'danger_reduce',values:[0.25,0.40,0.50,0.60,0.75]},
    secondary:{type:'travel_reduce',desc:'−25 Energy travel cost to scouted region',unlockLv:3},
    legendary:'Once/day: instant travel (0 Energy) to any Skyreach region',passive:{reducedRisk:0.15,energyCostMultiplier:{travel:-0.25}}},
...
var FACTION_PAIRS=[
  ...
  {id:'fp_ash_vw',loc:'cindervale',factions:['ashwardens','veilwalkers'],name:'Ashwardens ↔ Veilwalkers',icon:'⚔️🌀',dc:13,
    ...
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','Weapon enchants +25% coin, +25% all reputation gains'],
  ...
  {id:'fp_tc_hm_pd',factions:['harbormasters','pearl_divers'],name:'Harbormasters ↔ Pearl Divers',icon:'⚓🤿',dc:11,loc:'tidecrest',
    ...
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','+1 forage yield in the Trench & Labyrinth, +25% all reputation gains'],
    effect:{regionForage_abyssal_trench:1,regionForage_coral_labyrinth:1}},
  {id:'fp_tc_hm_tk',factions:['harbormasters','tidekeepers'],name:'Harbormasters ↔ Tidekeepers',icon:'⚓🌊',dc:10,loc:'tidecrest',
    desc:'Authority and faith — the Guild charts the harbor, the Tidekeepers bless it.',
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','10% fewer expedition dangers, +25% all reputation gains'],
    effect:{reducedRisk:0.10}},
  {id:'fp_tc_hm_mm',factions:['harbormasters','merchant_marine'],name:'Harbormasters ↔ Merchant Marine',icon:'⚓🚢',dc:12,loc:'tidecrest',
    desc:'The inspectors and the traders — every manifest is a negotiation between law and profit.',
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','Trade routes 1 day faster, +25% all reputation gains'],
    effect:{caravanSpeedBonus:1}},
  {id:'fp_tc_pd_tk',factions:['pearl_divers','tidekeepers'],name:'Pearl Divers ↔ Tidekeepers',icon:'🤿🌊',dc:11,loc:'tidecrest',
    desc:'The harvesters and the wardens of the deep — one dives for pearls, the other prays the sea forgives it.',
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','+15% rare find chance, +25% all reputation gains'],
    effect:{rareForageBonus:0.15}},
  {id:'fp_tc_pd_mm',factions:['pearl_divers','merchant_marine'],name:'Pearl Divers ↔ Merchant Marine',icon:'🤿🚢',dc:10,loc:'tidecrest',
    desc:'The hands that harvest and the fleet that sells — the reef\'s wealth needs both to reach market.',
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','Ingredients sell +2s each, +25% all reputation gains'],
    effect:{ingrSellBonus:2}},
  {id:'fp_tc_tk_mm',factions:['tidekeepers','merchant_marine'],name:'Tidekeepers ↔ Merchant Marine',icon:'🌊🚢',dc:13,loc:'tidecrest',
    desc:'Sacred tides and shipping lanes — the keepers say some waters are not for sale.',
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','+10% all XP, +25% all reputation gains'],
    effect:{xpMultiplier:0.10}},
  // Skyreach
  {id:'fp_sr_sw_sc',factions:['skywardens','starcallers'],name:'Skywardens ↔ Starcallers',icon:'🦅🌠',dc:10,loc:'skyreach',
    desc:'The watch on the peaks and the eyes on the stars — both keep vigil over Skyreach.',
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','+15% quest coin, +25% all reputation gains'],
    effect:{questGoldBonus:0.15}},
  {id:'fp_sr_sw_ct',factions:['skywardens','cloud_traders'],name:'Skywardens ↔ Cloud Traders',icon:'🦅🪁',dc:11,loc:'skyreach',
    desc:'The guardians of the passes and the caravans that cross them — protection has a price, and so does passage.',
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','10% fewer expedition dangers, +25% all reputation gains'],
    effect:{reducedRisk:0.10}},
  {id:'fp_sr_sw_wr',factions:['skywardens','windrunners'],name:'Skywardens ↔ Windrunners',icon:'🦅🌪️',dc:13,loc:'skyreach',
    desc:'Steel discipline and the untamed wind — the hardest alliance on the mountain, and the strongest.',
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','Armor enchants +25% coin, +25% all reputation gains'],
    effect:{categoricalEnchantBonus:{armor:{enchantGoldBonus:0.25}}}},
  {id:'fp_sr_sc_ct',factions:['starcallers','cloud_traders'],name:'Starcallers ↔ Cloud Traders',icon:'🌠🪁',dc:10,loc:'skyreach',
    desc:'Commerce and the cosmos — the Traders fund the observatories, the stars favor the caravans.',
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','+10% potion value, +25% all reputation gains'],
    effect:{potionValueBonus:0.10}},
  {id:'fp_sr_sc_wr',factions:['starcallers','windrunners'],name:'Starcallers ↔ Windrunners',icon:'🌠🌪️',dc:11,loc:'skyreach',
    desc:'Starlight and stormwind — two readings of the same sky, rarely taken together.',
    rewards:['Shop stocks +2 extra items daily','15% vendor discount','Celestial Ink +2 brew checks, +25% all reputation gains'],
    effect:{recipeBonus_celestial_ink:2}},
  {id:'fp_sr_ct_wr',factions:['cloud_traders','windrunners'],name:'Cloud Traders ↔ Windrunners',icon:'🪁🌪️',dc:12,loc:'skyreach',
...
var PRESTIGE_CLASSES={
  ...
  spellbrewer:{id:'spellbrewer',name:'Spellbrewer',icon:'⚗️',color:'#9060c0',
    ...
    features:[
      ...
      {lv:3,name:'Essence Weaver',desc:'Unlock Prosperity infusion. 4 infusions per day. 25% chance to preserve the catalyst on any infusion brew — success or failure.',effects:{infusionSlots:4,catalystSaveOnFail:0.25}},
      {lv:4,name:'Arcane Distiller',desc:'Unlock Lingering infusion. 5 infusions per day. Catalyst always preserved on a successful Masterwork (or higher) brew; failed Masterwork attempts have a 40% save chance.',effects:{infusionSlots:5,catalystSaveOnFail:0.40}},
      {lv:5,name:'Grand Spellbrewer',desc:'6 infusions per day. Infusion sale-multipliers are 50% more potent (Vigor 1.2× becomes 1.3×, Prosperity 1.5× becomes 1.75×, etc.) and infused items pay +30% coin. Infused shelf potions also attract +15% extra sell chance.',effects:{infusionSlots:6,infusedSellBonus:0.30}},
    ]},
  ...
  brandmaster:{id:'brandmaster',name:'Brand Master',icon:'🏷️',color:'#d0a060',
    ...
    features:[
      ...
      {lv:5,name:'Legendary Brand',desc:'3rd brand slot. Every branded item sells for an additional +25% coin on top of brand-level bonuses. 25% brand rep carries through Torch.',effects:{brandSlots:3,maxRecipes:4,torchBrandRep:0.25}},
    ]},
  ...
  antiquarian:{id:'antiquarian',name:'Antiquarian',icon:'📖',color:'#c0a080',
    ...
    features:[
      ...
      {lv:5,name:'Grand Collection',desc:'Complete all 5 sets for +1g/morning museum income. Legendary relics in diff 4+. Set bonuses doubled.',effects:{relicChance:0.35,legendaryRelics:true,museumIncome:10,doubleSetBonus:true}},
    ]},
  ...
  arcanist:{id:'arcanist',name:'Arcanist',icon:'✨',color:'#8060c0',
    ...
    features:[
      {lv:1,name:'Pattern Research',desc:'Research a new enchantment pattern (free action). Choose effect type and power level.',legacyEffects:{enchantBonus:1}},
      ...
      {lv:4,name:'Pattern Library',desc:'Store up to 10 custom patterns. Every custom-pattern inscription has its DC reduced by 15% (rounded down), making mastered arcanist patterns easier to inscribe.',legacyEffects:{enchantBonus:2,staffEfficiencyBonus:0.15}},
...
var FACTIONS={ashwardens:{id:'ashwardens',loc:'cindervale',name:'Ashwardens',icon:'🛡️',color:TH.fAsh,res:'warden_sigil',
  ...
  tierBonuses:[
    ...
    {name:'Elite Contracts',desc:'+20% coin from all quest rewards.',effects:{questGoldBonus:0.20}},
  ...
  alignBonus:{name:'Veilseer',desc:'+25% enchant success, +20% discovery chance, research Energy -25%.',effects:{enchantSuccessFlat:25,discoveryChanceBonus:0.20,energyCostMultiplier:{research:-0.25}}},
  tierBonuses:[
    ...
    {name:'Veilseer',desc:'Research Energy cost -25%. See enchant success %.',effects:{energyCostMultiplier:{research:-0.25}}},
  ...
  flamekeepers:{id:'flamekeepers',loc:'ashfall',name:'Flamekeepers',icon:'🕯️',color:'#d06030',res:'flamekeeper_ember',
    ...
    tierBonuses:[
      ...
      {name:'Flamewarden',desc:'Research Energy cost -25%. +10% XP from all sources.',effects:{energyCostMultiplier:{research:-0.25},xpMultiplier:0.10}},
    ]},
  ...
  harbormasters:{id:'harbormasters',loc:'tidecrest',name:'Harbormaster\'s Guild',icon:'⚓',color:'#4080a0',res:'harbor_seal',
    ...
    tierBonuses:[
      {name:'Dock Access',desc:'+10% coin from all sales.',effects:{sellBonus:0.10}},
  ...
  tidekeepers:{id:'tidekeepers',loc:'tidecrest',name:'Tidekeepers',icon:'🌊',color:'#6080c0',res:'tidekeeper_sigil',
    ...
    tierBonuses:[
      ...
      {name:'Tidebound',desc:'Research Energy cost -25%. See enchant success %.',effects:{energyCostMultiplier:{research:-0.25}}},
    ]},
  ...
  windrunners:{id:'windrunners',loc:'skyreach',name:'Windrunners',icon:'🌪️',color:'#50808a',res:'windrunner_compass',
    alignBonus:{name:'Wind Adept',desc:'+25% enchant success, +20% discovery, research Energy -25%.',effects:{enchantSuccessFlat:25,discoveryChanceBonus:0.20,energyCostMultiplier:{research:-0.25}}},
    tierBonuses:[
      ...
      {name:'Pathfinder',desc:'Research Energy cost -25%. See enchant success %.',effects:{energyCostMultiplier:{research:-0.25}}},
    ]},
};
...
var H_EVENTS=[
  ...
  {prob:0.01,text:'A collapsed tunnel blocks your usual path.',check:{skill:'endurance',dc:13},
    ...
    failText:'You\'re forced to find a way around, losing precious time.',failEffect:'lose_time'},
...
var MILESTONES={
  ...
  wealthy:{id:'wealthy',name:'Golden Touch',icon:'💰',desc:'Accumulated 50 gold. Prosperity follows your work.'},
...
var TOWN_EVENTS=[
  ...
  {id:'te_ashstorm',loc:'cindervale',vibe:'danger',negative:true,prob:.08,minLv:0,text:'A heavy ash storm blankets Cindervale. The wilds will be treacherous today.',
    effect:()=>({flag:'ash_storm',msg:'Expedition travel +⚡25 today. Plan accordingly.'})},
  ...
  {id:'te_refugee',loc:'cindervale',vibe:'social',prob:.05,minLv:2,text:'Refugees from a distant village arrive seeking healing supplies.',
    effect:(s)=>{if((s.pots.healing_salve||0)>0)return{pots:{healing_salve:-1},gold:20,xp:50,rep:{hearthkeepers:15},msg:'You donate a Healing Salve. +2g, +50 XP, +15 Hearthkeeper rep.'};return{msg:'They need healing salves, but you have none to spare. Perhaps tomorrow.'};}},
  {id:'te_inspector',loc:'cindervale',vibe:'official',prob:.04,minLv:5,text:'A guild inspector from the capital evaluates your workshop.',
    effect:(s)=>{const score=s.upgrades.length*5+s.level*3;if(score>=40)return{gold:30,xp:60,msg:`Rating: Excellent! +3g bonus, +60 XP. "Impressive operation."`};return{xp:20,msg:`Rating: Adequate. +20 XP. "Room for improvement."`};}},
  ...
  {id:'te_af_sandstorm',vibe:'danger',negative:true,loc:'ashfall',prob:.08,minLv:0,text:'A massive sandstorm sweeps across Ashfall Crossing. The desert is impassable today.',
    effect:()=>({flag:'ash_storm',msg:'Expedition travel +⚡25 today. The sand stings your eyes.'})},
  {id:'te_af_refugee',vibe:'social',loc:'ashfall',prob:.05,minLv:2,text:'Desert nomads arrive at the crossing, dehydrated and sunburnt. They need healing.',
    effect:(s)=>{if((s.pots.sunstroke_tonic||0)>0)return{pots:{sunstroke_tonic:-1},gold:20,xp:50,rep:{flamekeepers:15},msg:'You donate a Sunstroke Tonic. +2g, +50 XP, +15 Flamekeeper rep.'};return{msg:'They need sunstroke tonics, but you have none to spare.'};}},
  ...
  {id:'te_af_guild_inspect',vibe:'official',loc:'ashfall',prob:.04,minLv:5,text:'A Sand Merchants Guild auditor inspects your workshop. She takes notes silently.',
    effect:(s)=>{const score=s.upgrades.length*5+s.level*3;if(score>=40)return{gold:30,xp:60,rep:{sand_merchants:10},msg:`Rating: Exceptional! +3g, +60 XP, +10 Sand Merchant rep. "The Guild is impressed."`};return{xp:20,msg:`Rating: Developing. +20 XP. "Potential, but the Guild expects more."`};}},
  ...
  {id:'te_af_camel_caravan',vibe:'trade',loc:'ashfall',prob:.06,minLv:1,text:'A massive camel caravan arrives from the far coast, laden with exotic goods and eager to trade.',
    effect:()=>{const picks=['crystal_salt','sandsilk','obsidian_shard','thornvine'];var id=picks[Math.floor(Math.random()*picks.length)];return{items:{[id]:3},gold:5,msg:`The traders share 3× ${INGR[id]?.icon}${INGR[id]?.name} and 5s in good faith.`};}},
  ...
  {id:'te_tc_shipwreck',vibe:'danger',loc:'tidecrest',prob:.04,minLv:4,text:'A ship founders on the reef. Salvage crews rush to help — and loot.',
    effect:()=>{const picks=['rust_iron','waterlogged_timber','cannon_bronze','ghost_lantern'];var id=picks[Math.floor(Math.random()*picks.length)];return{items:{[id]:1},gold:10,msg:`Salvage haul: 1× ${INGR[id]?.icon}${INGR[id]?.name} + 1g`};}},
  ...
  {id:'te_tc_refugee',vibe:'social',loc:'tidecrest',prob:.05,minLv:2,text:'Shipwrecked sailors wash ashore, battered and salt-sick. They need healing.',
    effect:(s)=>{if((s.pots.brine_tonic||0)>0)return{pots:{brine_tonic:-1},gold:20,xp:50,rep:{tidekeepers:15},msg:'You donate a Brine Tonic. +2g, +50 XP, +15 Tidekeeper rep.'};return{msg:'They need brine tonics, but you have none to spare.'};}},
  ...
  {id:'te_tc_inspector',vibe:'official',loc:'tidecrest',prob:.04,minLv:5,text:'A maritime guild inspector evaluates your workshop.',
    effect:(s)=>{const score=s.upgrades.length*5+s.level*3;if(score>=40)return{gold:30,xp:60,msg:`Rating: Excellent! +3g bonus, +60 XP. "Finest harbor alchemy I've inspected."`};return{xp:20,msg:`Rating: Adequate. +20 XP. "The fleet expects better."`};}},
  ...
  {id:'sr_ev1',loc:'skyreach',vibe:'nature',prob:0.08,minLv:0,text:'Clear Skies — A rare cloudless day in Skyreach. The whole settlement celebrates.',
    effect:()=>({gold:8,msg:'The festival attracts visitors. +8s in tips.'})},
  ...
  {id:'sr_ev4',loc:'skyreach',vibe:'trade',prob:0.07,minLv:0,text:'Cloud Trader Caravan — Fresh supplies arrive from below.',
    effect:()=>({gold:5,msg:'Trade goods arrive. +5s in discounted purchases.'})},
  ...
  {id:'sr_ev7',loc:'skyreach',vibe:'social',prob:0.06,minLv:2,text:'Mountain Goat Migration — Herders celebrate the annual migration with feasting.',
    effect:()=>({gold:10,msg:'Visitors buy potions for the festival. +1g.'})},
  ...
  {id:'sr_ev9',loc:'skyreach',vibe:'trade',prob:0.06,minLv:0,text:'Windforge Market Day — Kael runs a special sale on mountain ingredients.',
    effect:()=>({gold:6,msg:'Good deals at market. +6s saved on purchases.'})},
  ...
  {id:'sr_ev12',loc:'skyreach',vibe:'social',prob:0.04,minLv:3,text:'Summit Race — Climbers compete to reach the peak fastest. You place a bet.',
    effect:()=>({gold:Math.random()>0.5?15:-5,msg:Math.random()>0.5?'Your climber wins! +1g 5s.':'Your climber loses. -5s.'})},
  {id:'sr_ev13',loc:'skyreach',vibe:'social',prob:0.05,minLv:2,text:'Cloud Wine Season — The local vintage is ready. Everyone is in high spirits.',
    effect:()=>({gold:8,msg:'Cloud wine sales boost income. +8s.'})},
  {id:'sr_ev14',loc:'skyreach',vibe:'military',prob:0.05,minLv:2,text:'Skywarden Patrol Bonus — The wardens share confiscated sky raider goods.',
    effect:()=>{const picks=['gale_salt','wind_iron','skystone_chip','rime_dust'];var id=picks[Math.floor(Math.random()*picks.length)];return{items:{[id]:2},gold:5,msg:'Confiscated goods: 2\u00d7 '+((INGR[id]||{}).icon||'')+((INGR[id]||{}).name||id)+' + 5s.'}}},
  {id:'sr_ev15',loc:'skyreach',vibe:'trade',prob:0.06,minLv:0,text:'Thin Air Tonic Sales — Visitors from below buy altitude remedies.',
    effect:()=>({gold:12,msg:'Altitude tonic demand is high. +1g 2s.'})},
...
var CRISIS_TEMPLATES=[
  ...
  {id:'morale',name:'Morale Collapse',icon:'😰',narrative:'Fear spreads. Citizens pack to flee. Without hope, the defense crumbles.',
    solutions:[
      ...
      {id:'pay_bounty',label:'Post Bounties',icon:'💰',skill:null,stat:null,costType:'gold',desc:'Offer coin bounties to anyone who fights. Money talks.'},
    ]},
...
var MARCH_RECIPES=[
  {id:'march_fortify',name:'Fortification Draught',icon:'🏰',ingr:['ironroot_bark','hearthstone','volcanic_essence'],xp:120,unlock:10,dc:16,stat:'tec',cat:'utility',
...
var SETTLEMENT_PROJECTS=[
  {id:'sp_roads',name:'Paved Roads',icon:'🛤️',desc:'Smooth roads reduce travel time across all regions.',
    ...
    buildDays:3,effect:{energyCostMultiplier:{travel:-0.25}},effectDesc:'Travel Energy cost -25% to all regions',req:null,tier:1},
  ...
  {id:'sp_academy',name:'Academy',icon:'🎓',desc:'A center of learning that accelerates all research and growth.',
    ...
    buildDays:8,effect:{xpMultiplier:0.10,energyCostMultiplier:{research:-0.25}},effectDesc:'+10% XP permanently, research Energy cost -25%, staff specialization',req:null,tier:3},
  {id:'sp_walls',name:'Fortified Walls',icon:'🏰',desc:'Massive walls that protect the settlement from the worst threats.',
    ...
    buildDays:10,effect:{threatCap:80,negativeEventReduction:0.50,tradeConfidenceGold:50},effectDesc:'Threats capped at 80, events halved, +5g/morning',req:'sp_watchtower',tier:4},
  {id:'sp_library',name:'Grand Library',icon:'📚',desc:'A repository of all alchemical knowledge in the realm.',
    ...
    buildDays:12,effect:{discoveryChanceBonus:0.25,loreDropChance:0.15,paperGoldMult:2},effectDesc:'+25% discovery, +15% lore drops, 2× paper income',req:'sp_academy',tier:4},
