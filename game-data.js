...
var CLASSES={
  ...
  enchanter:{id:'enchanter',name:'Enchanter',icon:'✨',color:TH.purple,primaryStat:'tec',
    ...
    specs:{
      ...
      spellweaver:{id:'spellweaver',name:'Spellweaver',desc:'Craft exotic utility enchantments and tap into planar power sources. Attract rare, high-paying customers.',mechDesc:'Planar Attunement. Attune to extraplanar power sources via the Planar Focus interface — selecting an active plane (Feywild, Shadowfell, Elemental Chaos, or Astral Sea) modifies your enchantments with that plane\'s exotic effects for 1 day (2 days from Lv6). Bonuses focus on the "other" enchantment category (accessory/utility inscriptions: rings, cloaks, charms): +1 inscription at Lv3, +35% gold and +1 customer slot at Lv6. At Lv10, **Planar Convergence** unlocks — attune to a second plane while the first is still active, fusing them into a combo (Twilight Veil, Wild Magic, Dreamweave, Void Storm, Null Space, or Primordial Order) with its own unique effect. Lv10 also grants inscription crits on 17+, +50% gold from enchanting overall, and +30% gold from potion customers.',icon:'🌀',color:'#a060e0',bStat:'inu',bSkills:['arcane_sense','divination'],
        features:[
