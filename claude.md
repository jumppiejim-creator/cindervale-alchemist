...
- **Open design questions** are consolidated in `_migration/open_design_questions.md` — literal Tier-3 planar interpretations, customer→faction mapping, Runesmith/Tinkerer/Apothecary in-screen guidance polish. FACTION_PAIRS (#6) and the per-level feature sufficiency expansion (#7) are closed.
